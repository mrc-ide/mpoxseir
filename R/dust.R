...
simple_SEIR_odindust <- R6::R6Class(
  "dust",
  cloneable = FALSE,
  ...
  private = list(
    ...
    ode_control_ = NULL,
    methods_ = NULL,
    param_ = list(beta = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     beta_zoonotic = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     E02 = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
  ...
  public = list(
    initialize = function(pars, time, n_particles, n_threads = 1L,
      ...
      if (is.null(gpu_config)) {
        private$methods_ <- list(
           alloc = dust_cpu_simple_SEIR_odindust_alloc,
           run = dust_cpu_simple_SEIR_odindust_run,
           simulate = dust_cpu_simple_SEIR_odindust_simulate,
           run_adjoint = dust_cpu_simple_SEIR_odindust_run_adjoint,
           set_index = dust_cpu_simple_SEIR_odindust_set_index,
           n_state = dust_cpu_simple_SEIR_odindust_n_state,
           update_state = dust_cpu_simple_SEIR_odindust_update_state,
           state = dust_cpu_simple_SEIR_odindust_state,
           time = dust_cpu_simple_SEIR_odindust_time,
           reorder = dust_cpu_simple_SEIR_odindust_reorder,
           resample = dust_cpu_simple_SEIR_odindust_resample,
           rng_state = dust_cpu_simple_SEIR_odindust_rng_state,
           set_rng_state = dust_cpu_simple_SEIR_odindust_set_rng_state,
           set_n_threads = dust_cpu_simple_SEIR_odindust_set_n_threads,
           set_data = dust_cpu_simple_SEIR_odindust_set_data,
           compare_data = dust_cpu_simple_SEIR_odindust_compare_data,
           filter = dust_cpu_simple_SEIR_odindust_filter,
           set_stochastic_schedule = dust_cpu_simple_SEIR_odindust_set_stochastic_schedule,
           ode_statistics = dust_cpu_simple_SEIR_odindust_ode_statistics)
      } else {
    ...
    has_openmp = function() {
      dust_cpu_simple_SEIR_odindust_capabilities()[["openmp"]]
    },
    ...
    has_gpu_support = function(fake_gpu = FALSE) {
      if (fake_gpu) {
        ...
        dust_cpu_simple_SEIR_odindust_capabilities()[["gpu"]]
      }
    },

    has_compare = function() {
      dust_cpu_simple_SEIR_odindust_capabilities()[["compare"]]
    },

    real_size = function() {
      dust_cpu_simple_SEIR_odindust_capabilities()[["real_size"]]
    },

    time_type = function() {
      dust_cpu_simple_SEIR_odindust_capabilities()[["time_type"]]
    },

    rng_algorithm = function() {
      dust_cpu_simple_SEIR_odindust_capabilities()[["rng_algorithm"]]
    },
    ...
    gpu_info = function() {
      ret <- dust_simple_SEIR_odindust_gpu_info()
...
class(simple_SEIR_odindust) <- c("dust_generator", class(simple_SEIR_odindust))
