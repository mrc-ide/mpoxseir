...
model <- R6::R6Class(
  ...
  private = list(
    ...
    ode_control_ = NULL,
    methods_ = NULL,
    param_ = list(m = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     CFR = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     D0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     Ea0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     Eb0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     Id0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     Ir0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     R0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     S0 = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     beta_h = list(has_default = TRUE, default_value = 0L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     beta_z = list(has_default = TRUE, default_value = 0L, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     dt = list(has_default = TRUE, default_value = 1L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     gamma_E = list(has_default = TRUE, default_value = 0L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     gamma_Id = list(has_default = TRUE, default_value = 0L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     gamma_Ir = list(has_default = TRUE, default_value = 0L, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     n_group = list(has_default = TRUE, default_value = 18L, rank = 0, min = -Inf, max = Inf, integer = FALSE)),
    reload_ = NULL
  ),
