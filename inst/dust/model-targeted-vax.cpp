...
public:
  ...
  size_t size() const {
    return shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_I + shared->dim_Id + shared->dim_Ir + shared->dim_N + shared->dim_R + shared->dim_S + 37;
  }
  std::vector<real_type> initial(size_t step, rng_state_type& rng_state) {
    std::vector<real_type> state(shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_I + shared->dim_Id + shared->dim_Ir + shared->dim_N + shared->dim_R + shared->dim_S + 37);
    ...
    state[4] = shared->initial_cases_cumulative;
    state[5] = shared->initial_deaths_cumulative;
    state[6] = shared->initial_cases_0_5;
    state[7] = shared->initial_cases_05_15;
    state[8] = shared->initial_cases_15_plus;
    state[9] = shared->initial_cases_PBS;
    state[10] = shared->initial_cases_SW;
    state[11] = shared->initial_deaths_0_5;
    state[12] = shared->initial_deaths_05_15;
    state[13] = shared->initial_deaths_15_plus;
    state[14] = shared->initial_deaths_PBS;
    state[15] = shared->initial_deaths_SW;
    state[16] = shared->initial_cases_cumulative_0_5;
    state[17] = shared->initial_cases_cumulative_05_15;
    state[18] = shared->initial_cases_cumulative_15_plus;
    state[19] = shared->initial_cases_cumulative_PBS;
    state[20] = shared->initial_cases_cumulative_SW;
    state[21] = shared->initial_deaths_cumulative_0_5;
    state[22] = shared->initial_deaths_cumulative_05_15;
    state[23] = shared->initial_deaths_cumulative_15_plus;
    state[24] = shared->initial_deaths_cumulative_PBS;
    state[25] = shared->initial_deaths_cumulative_SW;
    state[26] = shared->initial_vax_given_S;
    state[27] = shared->initial_vax_given_Ea;
    state[28] = shared->initial_vax_given_Eb;
    state[29] = shared->initial_vax_given_R;
    state[30] = shared->initial_S_tot;
    state[31] = shared->initial_E_tot;
    state[32] = shared->initial_I_tot;
    state[33] = shared->initial_R_tot;
    state[34] = shared->initial_D_tot;
    state[35] = shared->initial_N_tot;
    state[36] = shared->initial_total_vax;
    std::copy(shared->initial_S.begin(), shared->initial_S.end(), state.begin() + 37);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type vax_given_S = state[26];
    const real_type vax_given_Ea = state[27];
    const real_type vax_given_Eb = state[28];
    const real_type vax_given_R = state[29];
    const real_type * S = state + 37;
    ...
    const real_type cases_0_5 = state[6];
    const real_type cases_05_15 = state[7];
    const real_type cases_15_plus = state[8];
    const real_type cases_PBS = state[9];
    const real_type cases_SW = state[10];
    const real_type deaths = state[3];
    const real_type deaths_0_5 = state[11];
    const real_type deaths_05_15 = state[12];
    const real_type deaths_15_plus = state[13];
    const real_type deaths_PBS = state[14];
    const real_type deaths_SW = state[15];
    const real_type total_vax = state[36];
    state_next[0] = (step + 1) * shared->dt;
    state_next[36] = total_vax + vax_given_S + vax_given_Ea + vax_given_Eb + vax_given_R;
    real_type is_same_week = fmodr<real_type>(step, shared->steps_per_week) > 0;
    state_next[34] = odin_sum2<real_type>(D, 0, shared->dim_D_1, 0, shared->dim_D_2, shared->dim_D_1);
    ...
    state_next[31] = odin_sum2<real_type>(E, 0, shared->dim_E_1, 0, shared->dim_E_2, shared->dim_E_1);
    ...
    state_next[32] = odin_sum2<real_type>(I, 0, shared->dim_I_1, 0, shared->dim_I_2, shared->dim_I_1);
    ...
    state_next[5] = deaths + odin_sum2<real_type>(internal.n_IdD.data(), 0, shared->dim_n_IdD_1, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[21] = deaths_0_5 + odin_sum2<real_type>(internal.n_IdD.data(), 0, 1, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[22] = deaths_05_15 + odin_sum2<real_type>(internal.n_IdD.data(), 1, 3, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[23] = deaths_15_plus + odin_sum2<real_type>(internal.n_IdD.data(), 3, 16, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[24] = deaths_PBS + odin_sum2<real_type>(internal.n_IdD.data(), 16, 17, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[25] = deaths_SW + odin_sum2<real_type>(internal.n_IdD.data(), 17, 18, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    ...
    state_next[27] = odin_sum2<real_type>(internal.n_vaccination_t_Ea.data(), 0, shared->dim_n_vaccination_t_Ea_1, 0, shared->dim_n_vaccination_t_Ea_2, shared->dim_n_vaccination_t_Ea_1);
    state_next[28] = odin_sum2<real_type>(internal.n_vaccination_t_Eb.data(), 0, shared->dim_n_vaccination_t_Eb_1, 0, shared->dim_n_vaccination_t_Eb_2, shared->dim_n_vaccination_t_Eb_1);
    state_next[29] = odin_sum2<real_type>(internal.n_vaccination_t_R.data(), 0, shared->dim_n_vaccination_t_R_1, 0, shared->dim_n_vaccination_t_R_2, shared->dim_n_vaccination_t_R_1);
    state_next[26] = odin_sum2<real_type>(internal.n_vaccination_t_S.data(), 0, shared->dim_n_vaccination_t_S_1, 0, shared->dim_n_vaccination_t_S_2, shared->dim_n_vaccination_t_S_1);
    ...
    state_next[4] = cases + odin_sum2<real_type>(internal.n_SEa.data(), 0, shared->dim_n_SEa_1, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[16] = cases_0_5 + odin_sum2<real_type>(internal.n_SEa.data(), 0, 1, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[17] = cases_05_15 + odin_sum2<real_type>(internal.n_SEa.data(), 1, 3, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[18] = cases_15_plus + odin_sum2<real_type>(internal.n_SEa.data(), 3, 16, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[19] = cases_PBS + odin_sum2<real_type>(internal.n_SEa.data(), 16, 17, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[20] = cases_SW + odin_sum2<real_type>(internal.n_SEa.data(), 17, 18, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
...
dust::pars_type<model_targeted_vax> dust_pars<model_targeted_vax>(cpp11::list user) {
  ...
  shared->offset_variable_E = shared->dim_D + shared->dim_Ea + shared->dim_Eb + shared->dim_Id + shared->dim_Ir + shared->dim_R + shared->dim_S + 37;
  shared->offset_variable_Ea = shared->dim_S + 37;
  shared->offset_variable_Eb = shared->dim_Ea + shared->dim_S + 37;
  shared->offset_variable_I = shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_Id + shared->dim_Ir + shared->dim_R + shared->dim_S + 37;
  shared->offset_variable_Id = shared->dim_Ea + shared->dim_Eb + shared->dim_Ir + shared->dim_S + 37;
  shared->offset_variable_Ir = shared->dim_Ea + shared->dim_Eb + shared->dim_S + 37;
...
cpp11::sexp dust_info<model_targeted_vax>(const dust::pars_type<model_targeted_vax>& pars) {
  ...
  cpp11::writable::strings nms({"time", "prioritisation_step", "cases", "deaths", "cases_cumulative", "deaths_cumulative", "cases_0_5", "cases_05_15", "cases_15_plus", "cases_PBS", "cases_SW", "deaths_0_5", "deaths_05_15", "deaths_15_plus", "deaths_PBS", "deaths_SW", "cases_cumulative_0_5", "cases_cumulative_05_15", "cases_cumulative_15_plus", "cases_cumulative_PBS", "cases_cumulative_SW", "deaths_cumulative_0_5", "deaths_cumulative_05_15", "deaths_cumulative_15_plus", "deaths_cumulative_PBS", "deaths_cumulative_SW", "vax_given_S", "vax_given_Ea", "vax_given_Eb", "vax_given_R", "S_tot", "E_tot", "I_tot", "R_tot", "D_tot", "N_tot", "total_vax", "S", "Ea", "Eb", "Ir", "Id", "R", "D", "E", "I", "N"});
  ...
  dim[37] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[38] = cpp11::writable::integers({shared->dim_Ea_1, shared->dim_Ea_2});
  dim[39] = cpp11::writable::integers({shared->dim_Eb_1, shared->dim_Eb_2});
  dim[40] = cpp11::writable::integers({shared->dim_Ir_1, shared->dim_Ir_2});
  dim[41] = cpp11::writable::integers({shared->dim_Id_1, shared->dim_Id_2});
  dim[42] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2});
  dim[43] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[44] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2});
  dim[45] = cpp11::writable::integers({shared->dim_I_1, shared->dim_I_2});
  dim[46] = cpp11::writable::integers({shared->dim_N_1, shared->dim_N_2});
  dim.names() = nms;
  ...
  index[37] = integer_sequence(38, shared->dim_S);
  index[38] = integer_sequence(shared->offset_variable_Ea + 1, shared->dim_Ea);
  index[39] = integer_sequence(shared->offset_variable_Eb + 1, shared->dim_Eb);
  index[40] = integer_sequence(shared->offset_variable_Ir + 1, shared->dim_Ir);
  index[41] = integer_sequence(shared->offset_variable_Id + 1, shared->dim_Id);
  index[42] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[43] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[44] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[45] = integer_sequence(shared->offset_variable_I + 1, shared->dim_I);
  index[46] = integer_sequence(shared->offset_variable_N + 1, shared->dim_N);
  index.names() = nms;
