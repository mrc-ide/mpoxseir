...
// Generated by odin.dust (version 0.3.12) - do not edit
...
public:
  ...
  size_t size() const {
    return shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_I + shared->dim_Id + shared->dim_Ir + shared->dim_N + shared->dim_R + shared->dim_S + 48;
  }
  std::vector<real_type> initial(size_t step, rng_state_type& rng_state) {
    std::vector<real_type> state(shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_I + shared->dim_Id + shared->dim_Ir + shared->dim_N + shared->dim_R + shared->dim_S + 48);
    ...
    state[27] = shared->initial_vax_given_S;
    state[28] = shared->initial_vax_given_Ea;
    state[29] = shared->initial_vax_given_Eb;
    state[30] = shared->initial_vax_given_R;
    state[31] = shared->initial_vax_1stdose_given_S;
    state[32] = shared->initial_vax_1stdose_given_Ea;
    state[33] = shared->initial_vax_1stdose_given_Eb;
    state[34] = shared->initial_vax_1stdose_given_R;
    state[35] = shared->initial_vax_2nddose_given_S;
    state[36] = shared->initial_vax_2nddose_given_Ea;
    state[37] = shared->initial_vax_2nddose_given_Eb;
    state[38] = shared->initial_vax_2nddose_given_R;
    state[39] = shared->initial_S_tot;
    state[40] = shared->initial_E_tot;
    state[41] = shared->initial_I_tot;
    state[42] = shared->initial_R_tot;
    state[43] = shared->initial_D_tot;
    state[44] = shared->initial_N_tot;
    state[45] = shared->initial_total_vax;
    state[46] = shared->initial_total_vax_1stdose;
    state[47] = shared->initial_total_vax_2nddose;
    std::copy(shared->initial_S.begin(), shared->initial_S.end(), state.begin() + 48);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type vax_given_S = state[27];
    const real_type vax_given_Ea = state[28];
    const real_type vax_given_Eb = state[29];
    const real_type vax_given_R = state[30];
    const real_type vax_1stdose_given_S = state[31];
    const real_type vax_1stdose_given_Ea = state[32];
    const real_type vax_1stdose_given_Eb = state[33];
    const real_type vax_1stdose_given_R = state[34];
    const real_type vax_2nddose_given_S = state[35];
    const real_type vax_2nddose_given_Ea = state[36];
    const real_type vax_2nddose_given_Eb = state[37];
    const real_type vax_2nddose_given_R = state[38];
    const real_type * S = state + 48;
    ...
    const real_type total_vax = state[45];
    const real_type total_vax_1stdose = state[46];
    const real_type total_vax_2nddose = state[47];
    state_next[0] = (step + 1) * shared->dt;
    state_next[45] = total_vax + vax_given_S + vax_given_Ea + vax_given_Eb + vax_given_R;
    state_next[46] = total_vax_1stdose + vax_1stdose_given_S + vax_1stdose_given_Ea + vax_1stdose_given_Eb + vax_1stdose_given_R;
    state_next[47] = total_vax_2nddose + vax_2nddose_given_S + vax_2nddose_given_Ea + vax_2nddose_given_Eb + vax_2nddose_given_R;
    real_type is_same_week = fmodr<real_type>(step, shared->steps_per_week) > 0;
    state_next[43] = odin_sum2<real_type>(D, 0, shared->dim_D_1, 0, shared->dim_D_2, shared->dim_D_1);
    ...
    state_next[40] = odin_sum2<real_type>(E, 0, shared->dim_E_1, 0, shared->dim_E_2, shared->dim_E_1);
    ...
    state_next[41] = odin_sum2<real_type>(I, 0, shared->dim_I_1, 0, shared->dim_I_2, shared->dim_I_1);
    ...
    state_next[44] = odin_sum2<real_type>(N, 0, shared->dim_N_1, 0, shared->dim_N_2, shared->dim_N_1);
    state_next[42] = odin_sum2<real_type>(R, 0, shared->dim_R_1, 0, shared->dim_R_2, shared->dim_R_1);
    state_next[39] = odin_sum2<real_type>(S, 0, shared->dim_S_1, 0, shared->dim_S_2, shared->dim_S_1);
    ...
    state_next[32] = odin_sum2<real_type>(internal.n_vaccination_t_Ea.data(), 0, shared->dim_n_vaccination_t_Ea_1, 1, 2, shared->dim_n_vaccination_t_Ea_1);
    state_next[33] = odin_sum2<real_type>(internal.n_vaccination_t_Eb.data(), 0, shared->dim_n_vaccination_t_Eb_1, 1, 2, shared->dim_n_vaccination_t_Eb_1);
    state_next[34] = odin_sum2<real_type>(internal.n_vaccination_t_R.data(), 0, shared->dim_n_vaccination_t_R_1, 1, 2, shared->dim_n_vaccination_t_R_1);
    state_next[31] = odin_sum2<real_type>(internal.n_vaccination_t_S.data(), 0, shared->dim_n_vaccination_t_S_1, 1, 2, shared->dim_n_vaccination_t_S_1);
    state_next[36] = odin_sum2<real_type>(internal.n_vaccination_t_Ea.data(), 0, shared->dim_n_vaccination_t_Ea_1, 2, 3, shared->dim_n_vaccination_t_Ea_1);
    state_next[37] = odin_sum2<real_type>(internal.n_vaccination_t_Eb.data(), 0, shared->dim_n_vaccination_t_Eb_1, 2, 3, shared->dim_n_vaccination_t_Eb_1);
    state_next[38] = odin_sum2<real_type>(internal.n_vaccination_t_R.data(), 0, shared->dim_n_vaccination_t_R_1, 2, 3, shared->dim_n_vaccination_t_R_1);
    state_next[35] = odin_sum2<real_type>(internal.n_vaccination_t_S.data(), 0, shared->dim_n_vaccination_t_S_1, 2, 3, shared->dim_n_vaccination_t_S_1);
    state_next[28] = odin_sum2<real_type>(internal.n_vaccination_t_Ea.data(), 0, shared->dim_n_vaccination_t_Ea_1, 0, shared->dim_n_vaccination_t_Ea_2, shared->dim_n_vaccination_t_Ea_1);
    state_next[29] = odin_sum2<real_type>(internal.n_vaccination_t_Eb.data(), 0, shared->dim_n_vaccination_t_Eb_1, 0, shared->dim_n_vaccination_t_Eb_2, shared->dim_n_vaccination_t_Eb_1);
    state_next[30] = odin_sum2<real_type>(internal.n_vaccination_t_R.data(), 0, shared->dim_n_vaccination_t_R_1, 0, shared->dim_n_vaccination_t_R_2, shared->dim_n_vaccination_t_R_1);
    state_next[27] = odin_sum2<real_type>(internal.n_vaccination_t_S.data(), 0, shared->dim_n_vaccination_t_S_1, 0, shared->dim_n_vaccination_t_S_2, shared->dim_n_vaccination_t_S_1);
...
dust::pars_type<model_targeted_vax> dust_pars<model_targeted_vax>(cpp11::list user) {
  ...
  shared->offset_variable_D = shared->dim_Ea + shared->dim_Eb + shared->dim_Id + shared->dim_Ir + shared->dim_R + shared->dim_S + 48;
  shared->offset_variable_E = shared->dim_D + shared->dim_Ea + shared->dim_Eb + shared->dim_Id + shared->dim_Ir + shared->dim_R + shared->dim_S + 48;
  shared->offset_variable_Ea = shared->dim_S + 48;
  shared->offset_variable_Eb = shared->dim_Ea + shared->dim_S + 48;
  shared->offset_variable_I = shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_Id + shared->dim_Ir + shared->dim_R + shared->dim_S + 48;
  shared->offset_variable_Id = shared->dim_Ea + shared->dim_Eb + shared->dim_Ir + shared->dim_S + 48;
  shared->offset_variable_Ir = shared->dim_Ea + shared->dim_Eb + shared->dim_S + 48;
  shared->offset_variable_N = shared->dim_D + shared->dim_E + shared->dim_Ea + shared->dim_Eb + shared->dim_I + shared->dim_Id + shared->dim_Ir + shared->dim_R + shared->dim_S + 48;
  shared->offset_variable_R = shared->dim_Ea + shared->dim_Eb + shared->dim_Id + shared->dim_Ir + shared->dim_S + 48;
...
cpp11::sexp dust_info<model_targeted_vax>(const dust::pars_type<model_targeted_vax>& pars) {
  ...
  dim[49] = cpp11::writable::integers({shared->dim_Ea_1, shared->dim_Ea_2});
  dim[50] = cpp11::writable::integers({shared->dim_Eb_1, shared->dim_Eb_2});
  dim[51] = cpp11::writable::integers({shared->dim_Ir_1, shared->dim_Ir_2});
  dim[52] = cpp11::writable::integers({shared->dim_Id_1, shared->dim_Id_2});
  dim[53] = cpp11::writable::integers({shared->dim_R_1, shared->dim_R_2});
  dim[54] = cpp11::writable::integers({shared->dim_D_1, shared->dim_D_2});
  dim[55] = cpp11::writable::integers({shared->dim_E_1, shared->dim_E_2});
  dim[56] = cpp11::writable::integers({shared->dim_I_1, shared->dim_I_2});
  dim[57] = cpp11::writable::integers({shared->dim_N_1, shared->dim_N_2});
  dim.names() = nms;
  ...
  index[48] = integer_sequence(49, shared->dim_S);
  index[49] = integer_sequence(shared->offset_variable_Ea + 1, shared->dim_Ea);
  index[50] = integer_sequence(shared->offset_variable_Eb + 1, shared->dim_Eb);
  index[51] = integer_sequence(shared->offset_variable_Ir + 1, shared->dim_Ir);
  index[52] = integer_sequence(shared->offset_variable_Id + 1, shared->dim_Id);
  index[53] = integer_sequence(shared->offset_variable_R + 1, shared->dim_R);
  index[54] = integer_sequence(shared->offset_variable_D + 1, shared->dim_D);
  index[55] = integer_sequence(shared->offset_variable_E + 1, shared->dim_E);
  index[56] = integer_sequence(shared->offset_variable_I + 1, shared->dim_I);
  index[57] = integer_sequence(shared->offset_variable_N + 1, shared->dim_N);
  index.names() = nms;
