...
public:
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    for (size_t i = 2; i <= static_cast<size_t>(shared.n_group); ++i) {
      internal.children_dose1_group[i - 1] = (dust2::array::sum<real_type>(internal.children_dose1_denom.data(), shared.dim.children_dose1_denom) == 0 ? 0 : monty::random::binomial<real_type>(rng_state, internal.daily_doses_children_t[1] - dust2::array::sum<real_type>(internal.children_dose1_group.data(), shared.dim.children_dose1_group, {0, (i - 1) - 1}), internal.children_dose1_prob[i - 1] / dust2::array::sum<real_type>(internal.children_dose1_prob.data(), shared.dim.children_dose1_prob, {i - 1, shared.n_group - 1})));
    }
    ...
    for (size_t i = 2; i <= static_cast<size_t>(shared.n_group); ++i) {
      internal.adults_dose1_group[i - 1] = (dust2::array::sum<real_type>(internal.adults_dose1_denom.data(), shared.dim.adults_dose1_denom) == 0 ? 0 : monty::random::binomial<real_type>(rng_state, internal.daily_doses_adults_t[1] - dust2::array::sum<real_type>(internal.adults_dose1_group.data(), shared.dim.adults_dose1_group, {0, (i - 1) - 1}), internal.adults_dose1_prob[i - 1] / dust2::array::sum<real_type>(internal.adults_dose1_prob.data(), shared.dim.adults_dose1_prob, {i - 1, shared.n_group - 1})));
    }
