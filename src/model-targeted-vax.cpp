...
// [[dust2::parameter(t_start, type = "real_type", rank = 0, required = TRUE, constant = FALSE)]]
...
// [[dust2::parameter(ageout_prop, type = "real_type", rank = 1, required = TRUE, constant = FALSE)]]
// [[dust2::parameter(all_deathrates, type = "real_type", rank = 2, required = TRUE, constant = FALSE)]]
// [[dust2::parameter(all_birthrates, type = "real_type", rank = 1, required = TRUE, constant = FALSE)]]
// [[dust2::parameter(proportion_births_vaxxed, type = "real_type", rank = 0, required = FALSE, constant = FALSE)]]
// [[dust2::parameter(wane_rate, type = "real_type", rank = 0, required = FALSE, constant = FALSE)]]
// [[dust2::parameter(prop_SW, type = "real_type", rank = 0, required = TRUE, constant = FALSE)]]
// [[dust2::parameter(prop_PBS, type = "real_type", rank = 0, required = FALSE, constant = FALSE)]]
...
public:
  ...
  struct shared_state {
    ...
    struct dim_type {
      ...
      dust2::array::dimensions<2> waning_S;
      ...
      dust2::array::dimensions<1> ageout_prop;
      dust2::array::dimensions<2> all_deathrates;
      dust2::array::dimensions<1> all_birthrates;
      dust2::array::dimensions<1> death_rate;
      dust2::array::dimensions<2> ageout_S;
      dust2::array::dimensions<2> background_deaths_S;
      dust2::array::dimensions<1> CSW_progressions_S;
      dust2::array::dimensions<1> PBS_progressions_S;
      dust2::array::dimensions<2> ageout_Ea;
      dust2::array::dimensions<2> background_deaths_Ea;
      dust2::array::dimensions<1> CSW_progressions_Ea;
      dust2::array::dimensions<1> PBS_progressions_Ea;
      dust2::array::dimensions<2> ageout_Eb;
      dust2::array::dimensions<2> background_deaths_Eb;
      dust2::array::dimensions<1> CSW_progressions_Eb;
      dust2::array::dimensions<1> PBS_progressions_Eb;
      dust2::array::dimensions<2> ageout_Ir;
      dust2::array::dimensions<2> background_deaths_Ir;
      dust2::array::dimensions<1> CSW_progressions_Ir;
      dust2::array::dimensions<1> PBS_progressions_Ir;
      dust2::array::dimensions<2> ageout_Id;
      dust2::array::dimensions<2> background_deaths_Id;
      dust2::array::dimensions<1> CSW_progressions_Id;
      dust2::array::dimensions<1> PBS_progressions_Id;
      dust2::array::dimensions<2> ageout_R;
      dust2::array::dimensions<2> background_deaths_R;
      dust2::array::dimensions<1> CSW_progressions_R;
      dust2::array::dimensions<1> PBS_progressions_R;
    } dim;
    ...
    real_type rho_00_04;
    real_type rho_00_14;
    real_type proportion_births_vaxxed;
    real_type wane_rate;
    real_type prop_SW;
    real_type prop_PBS;
    ...
    std::vector<real_type> ageout_prop;
    std::vector<real_type> all_deathrates;
    std::vector<real_type> all_birthrates;
  ...
  struct internal_state {
    std::vector<real_type> death_rate;
    ...
    std::vector<real_type> pre_birthdeath_D;
    ...
    std::vector<real_type> pre_birthdeath_waning_S;
    std::vector<real_type> n_SEa_hh;
    std::vector<real_type> n_EaEb;
    std::vector<real_type> delta_R_n_vaccination;
    std::vector<real_type> waning_S;
    std::vector<real_type> n_vaccination_t;
    std::vector<real_type> n_SEa_s;
    std::vector<real_type> n_EbI;
    std::vector<real_type> delta_Ea;
    std::vector<real_type> pre_birthdeath_Ea;
    std::vector<real_type> pre_birthdeath_R;
    std::vector<real_type> pre_birthdeath_S;
    std::vector<real_type> n_SEa_hc;
    std::vector<real_type> n_EbId;
    std::vector<real_type> delta_Eb;
    std::vector<real_type> pre_birthdeath_Eb;
    std::vector<real_type> ageout_S;
    std::vector<real_type> ageout_Ea;
    std::vector<real_type> ageout_R;
    std::vector<real_type> n_SEa_z;
    std::vector<real_type> n_EbIr;
    std::vector<real_type> delta_Id;
    std::vector<real_type> pre_birthdeath_Id;
    std::vector<real_type> background_deaths_S;
    std::vector<real_type> CSW_progressions_S;
    std::vector<real_type> PBS_progressions_S;
    std::vector<real_type> background_deaths_Ea;
    std::vector<real_type> CSW_progressions_Ea;
    std::vector<real_type> PBS_progressions_Ea;
    std::vector<real_type> ageout_Eb;
    std::vector<real_type> background_deaths_R;
    std::vector<real_type> CSW_progressions_R;
    std::vector<real_type> PBS_progressions_R;
    std::vector<real_type> delta_Ir;
    std::vector<real_type> pre_birthdeath_Ir;
    std::vector<real_type> agein_S;
    std::vector<real_type> agein_Ea;
    std::vector<real_type> background_deaths_Eb;
    std::vector<real_type> CSW_progressions_Eb;
    std::vector<real_type> PBS_progressions_Eb;
    std::vector<real_type> ageout_Id;
    std::vector<real_type> agein_R;
    std::vector<real_type> agein_Eb;
    std::vector<real_type> ageout_Ir;
    std::vector<real_type> background_deaths_Id;
    std::vector<real_type> CSW_progressions_Id;
    std::vector<real_type> PBS_progressions_Id;
    std::vector<real_type> new_S;
    std::vector<real_type> new_Ea;
    std::vector<real_type> new_R;
    std::vector<real_type> background_deaths_Ir;
    std::vector<real_type> CSW_progressions_Ir;
    std::vector<real_type> PBS_progressions_Ir;
    std::vector<real_type> agein_Id;
    std::vector<real_type> new_Eb;
    std::vector<real_type> agein_Ir;
  ...
  static shared_state build_shared(cpp11::list parameters) {
    ...
    const real_type t_start = dust2::r::read_real(parameters, "t_start");
    ...
    dim.ageout_prop.set({static_cast<size_t>(20)});
    dim.all_deathrates.set({static_cast<size_t>(20), static_cast<size_t>(79)});
    dim.all_birthrates.set({static_cast<size_t>(79)});
    dim.death_rate.set({static_cast<size_t>(20)});
    const real_type proportion_births_vaxxed = dust2::r::read_real(parameters, "proportion_births_vaxxed", 0);
    const real_type wane_rate = dust2::r::read_real(parameters, "wane_rate", 0);
    const real_type prop_SW = dust2::r::read_real(parameters, "prop_SW");
    const real_type prop_PBS = dust2::r::read_real(parameters, "prop_PBS", static_cast<real_type>(0.11) * static_cast<real_type>(0.5));
    dim.ageout_S.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.background_deaths_S.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.CSW_progressions_S.set({static_cast<size_t>(4)});
    dim.PBS_progressions_S.set({static_cast<size_t>(4)});
    dim.ageout_Ea.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.background_deaths_Ea.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.CSW_progressions_Ea.set({static_cast<size_t>(4)});
    dim.PBS_progressions_Ea.set({static_cast<size_t>(4)});
    dim.ageout_Eb.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.background_deaths_Eb.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.CSW_progressions_Eb.set({static_cast<size_t>(4)});
    dim.PBS_progressions_Eb.set({static_cast<size_t>(4)});
    dim.ageout_Ir.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.background_deaths_Ir.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.CSW_progressions_Ir.set({static_cast<size_t>(4)});
    dim.PBS_progressions_Ir.set({static_cast<size_t>(4)});
    dim.ageout_Id.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.background_deaths_Id.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.CSW_progressions_Id.set({static_cast<size_t>(4)});
    dim.PBS_progressions_Id.set({static_cast<size_t>(4)});
    dim.ageout_R.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.background_deaths_R.set({static_cast<size_t>(20), static_cast<size_t>(4)});
    dim.CSW_progressions_R.set({static_cast<size_t>(4)});
    dim.PBS_progressions_R.set({static_cast<size_t>(4)});
    ...
    dim.waning_S.set({static_cast<size_t>(n_group), static_cast<size_t>(n_vax)});
    ...
    std::vector<real_type> ageout_prop(dim.ageout_prop.size);
    dust2::r::read_real_array(parameters, dim.ageout_prop, ageout_prop.data(), "ageout_prop", true);
    std::vector<real_type> all_deathrates(dim.all_deathrates.size);
    dust2::r::read_real_array(parameters, dim.all_deathrates, all_deathrates.data(), "all_deathrates", true);
    std::vector<real_type> all_birthrates(dim.all_birthrates.size);
    dust2::r::read_real_array(parameters, dim.all_birthrates, all_birthrates.data(), "all_birthrates", true);
    ...
    return shared_state{odin, dim, N_prioritisation_steps_children, N_prioritisation_steps_adults, t_start, beta_h, beta_s, beta_hcw, gamma_E, gamma_Ir, gamma_Id, n_vax, n_group, exp_noise, phi_00_04, phi_05_14, phi_15_plus, phi_CSW_12_14, phi_CSW_15_17, phi_ASW, phi_HCW, phi_PBS, alpha_cases, alpha_cases_00_04, alpha_cases_05_14, alpha_cases_15_plus, alpha_deaths, alpha_deaths_00_04, alpha_deaths_05_14, alpha_deaths_15_plus, rho_00_04, rho_00_14, proportion_births_vaxxed, wane_rate, prop_SW, prop_PBS, daily_doses_children_value, daily_doses_children_time, daily_doses_adults_value, daily_doses_adults_time, ageout_prop, all_deathrates, all_birthrates, is_child, interpolate_daily_doses_children_t, interpolate_daily_doses_adults_t, prioritisation_strategy_children, prioritisation_strategy_adults, m_gen_pop, m_sex, seed_rate, S0, Ea0, Eb0, Ir0, Id0, R0, D0, beta_z, CFR, ve_T, ve_I, lambda_z};
  }
  static internal_state build_internal(const shared_state& shared) {
    std::vector<real_type> death_rate(shared.dim.death_rate.size);
    ...
    std::vector<real_type> pre_birthdeath_D(shared.dim.D.size);
    ...
    std::vector<real_type> pre_birthdeath_waning_S(shared.dim.S.size);
    ...
    std::vector<real_type> waning_S(shared.dim.waning_S.size);
    ...
    std::vector<real_type> pre_birthdeath_Ea(shared.dim.Ea.size);
    std::vector<real_type> pre_birthdeath_R(shared.dim.R.size);
    std::vector<real_type> pre_birthdeath_S(shared.dim.S.size);
    ...
    std::vector<real_type> pre_birthdeath_Eb(shared.dim.Eb.size);
    std::vector<real_type> ageout_S(shared.dim.ageout_S.size);
    std::vector<real_type> ageout_Ea(shared.dim.ageout_Ea.size);
    std::vector<real_type> ageout_R(shared.dim.ageout_R.size);
    ...
    std::vector<real_type> pre_birthdeath_Id(shared.dim.Id.size);
    std::vector<real_type> background_deaths_S(shared.dim.background_deaths_S.size);
    std::vector<real_type> CSW_progressions_S(shared.dim.CSW_progressions_S.size);
    std::vector<real_type> PBS_progressions_S(shared.dim.PBS_progressions_S.size);
    std::vector<real_type> background_deaths_Ea(shared.dim.background_deaths_Ea.size);
    std::vector<real_type> CSW_progressions_Ea(shared.dim.CSW_progressions_Ea.size);
    std::vector<real_type> PBS_progressions_Ea(shared.dim.PBS_progressions_Ea.size);
    std::vector<real_type> ageout_Eb(shared.dim.ageout_Eb.size);
    std::vector<real_type> background_deaths_R(shared.dim.background_deaths_R.size);
    std::vector<real_type> CSW_progressions_R(shared.dim.CSW_progressions_R.size);
    std::vector<real_type> PBS_progressions_R(shared.dim.PBS_progressions_R.size);
    std::vector<real_type> delta_Ir(shared.dim.delta_Ir.size);
    std::vector<real_type> pre_birthdeath_Ir(shared.dim.Ir.size);
    std::vector<real_type> agein_S(shared.dim.ageout_S.size);
    std::vector<real_type> agein_Ea(shared.dim.ageout_Ea.size);
    std::vector<real_type> background_deaths_Eb(shared.dim.background_deaths_Eb.size);
    std::vector<real_type> CSW_progressions_Eb(shared.dim.CSW_progressions_Eb.size);
    std::vector<real_type> PBS_progressions_Eb(shared.dim.PBS_progressions_Eb.size);
    std::vector<real_type> ageout_Id(shared.dim.ageout_Id.size);
    std::vector<real_type> agein_R(shared.dim.ageout_R.size);
    std::vector<real_type> agein_Eb(shared.dim.ageout_Eb.size);
    std::vector<real_type> ageout_Ir(shared.dim.ageout_Ir.size);
    std::vector<real_type> background_deaths_Id(shared.dim.background_deaths_Id.size);
    std::vector<real_type> CSW_progressions_Id(shared.dim.CSW_progressions_Id.size);
    std::vector<real_type> PBS_progressions_Id(shared.dim.PBS_progressions_Id.size);
    ...
    std::vector<real_type> background_deaths_Ir(shared.dim.background_deaths_Ir.size);
    std::vector<real_type> CSW_progressions_Ir(shared.dim.CSW_progressions_Ir.size);
    std::vector<real_type> PBS_progressions_Ir(shared.dim.PBS_progressions_Ir.size);
    std::vector<real_type> agein_Id(shared.dim.ageout_Id.size);
    std::vector<real_type> new_Eb(shared.dim.Eb.size);
    std::vector<real_type> agein_Ir(shared.dim.ageout_Ir.size);
    ...
    return internal_state{death_rate, n_IrR, n_IdD, coverage_target_1st_dose_children, coverage_target_1st_dose_adults, coverage_target_2nd_dose_adults, max_vax_remaining, I_infectious, delta_R, delta_D, daily_doses_children_t, daily_doses_adults_t, target_met_children_t, target_met_adults_t, pre_birthdeath_D, prop_infectious, lambda_hc, give_dose1_children, give_dose1_adults, give_dose2_adults, new_D, s_ij_gen_pop, s_ij_sex, children_dose1_denom, adults_dose1_denom, adults_dose2_denom, lambda_hh, lambda_s, children_dose1_prob, adults_dose1_prob, adults_dose2_prob, lambda, children_dose1_group, adults_dose1_group, adults_dose2_group, p_SE, p_hh, p_s, p_hc, n_vaccination_t_S_children, n_vaccination_t_S_adults, n_vaccination_t_Ea_children, n_vaccination_t_Ea_adults, n_vaccination_t_S, n_vaccination_t_Eb_children, n_vaccination_t_Eb_adults, n_vaccination_t_Ea, delta_S_n_vaccination, n_vaccination_t_R_children, n_vaccination_t_R_adults, n_vaccination_t_Eb, delta_Ea_n_vaccination, n_SEa, n_vaccination_t_R, delta_Eb_n_vaccination, pre_birthdeath_waning_S, n_SEa_hh, n_EaEb, delta_R_n_vaccination, waning_S, n_vaccination_t, n_SEa_s, n_EbI, delta_Ea, pre_birthdeath_Ea, pre_birthdeath_R, pre_birthdeath_S, n_SEa_hc, n_EbId, delta_Eb, pre_birthdeath_Eb, ageout_S, ageout_Ea, ageout_R, n_SEa_z, n_EbIr, delta_Id, pre_birthdeath_Id, background_deaths_S, CSW_progressions_S, PBS_progressions_S, background_deaths_Ea, CSW_progressions_Ea, PBS_progressions_Ea, ageout_Eb, background_deaths_R, CSW_progressions_R, PBS_progressions_R, delta_Ir, pre_birthdeath_Ir, agein_S, agein_Ea, background_deaths_Eb, CSW_progressions_Eb, PBS_progressions_Eb, ageout_Id, agein_R, agein_Eb, ageout_Ir, background_deaths_Id, CSW_progressions_Id, PBS_progressions_Id, new_S, new_Ea, new_R, background_deaths_Ir, CSW_progressions_Ir, PBS_progressions_Ir, agein_Id, new_Eb, agein_Ir, new_Id, new_E, new_Ir, new_I, new_N, new_target_met_children_t, new_target_met_adults_t, seed};
  }
  ...
  static void update_shared(cpp11::list parameters, shared_state& shared) {
    shared.t_start = dust2::r::read_real(parameters, "t_start", shared.t_start);
    ...
    shared.proportion_births_vaxxed = dust2::r::read_real(parameters, "proportion_births_vaxxed", shared.proportion_births_vaxxed);
    shared.wane_rate = dust2::r::read_real(parameters, "wane_rate", shared.wane_rate);
    shared.prop_SW = dust2::r::read_real(parameters, "prop_SW", shared.prop_SW);
    shared.prop_PBS = dust2::r::read_real(parameters, "prop_PBS", shared.prop_PBS);
    ...
    dust2::r::read_real_array(parameters, shared.dim.ageout_prop, shared.ageout_prop.data(), "ageout_prop", false);
    dust2::r::read_real_array(parameters, shared.dim.all_deathrates, shared.all_deathrates.data(), "all_deathrates", false);
    dust2::r::read_real_array(parameters, shared.dim.all_birthrates, shared.all_birthrates.data(), "all_birthrates", false);
    dust2::r::read_real_array(parameters, shared.dim.is_child, shared.is_child.data(), "is_child", false);
    shared.interpolate_daily_doses_children_t = dust2::interpolate::InterpolateConstantArray<real_type, 1>(shared.daily_doses_children_time, shared.daily_doses_children_value, shared.dim.daily_doses_children_t, "daily_doses_children_time", "daily_doses_children_value");
    shared.interpolate_daily_doses_adults_t = dust2::interpolate::InterpolateConstantArray<real_type, 1>(shared.daily_doses_adults_time, shared.daily_doses_adults_value, shared.dim.daily_doses_adults_t, "daily_doses_adults_time", "daily_doses_adults_value");
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    const real_type birth_death_year_entry = monty::math::floor<real_type>(time / 365) + 2;
    const real_type p_EE = 1 - monty::math::exp<real_type>(-shared.gamma_E * 2 * dt);
    const real_type p_EI = 1 - monty::math::exp<real_type>(-shared.gamma_E * 2 * dt);
    const real_type p_IrR = 1 - monty::math::exp<real_type>(-shared.gamma_Ir * dt);
    const real_type p_IdD = 1 - monty::math::exp<real_type>(-shared.gamma_Id * dt);
    for (size_t i = 1; i <= shared.dim.death_rate.size; ++i) {
      internal.death_rate[i - 1] = shared.all_deathrates[i - 1 + (birth_death_year_entry - 1) * shared.dim.all_deathrates.mult[1]];
    }
    const real_type birthrate = shared.all_birthrates[birth_death_year_entry - 1];
    ...
    for (size_t i = 1; i <= shared.dim.coverage_target_1st_dose_children.size; ++i) {
      internal.coverage_target_1st_dose_children[i - 1] = monty::math::ceil<real_type>(shared.prioritisation_strategy_children[i - 1 + (prioritisation_step_1st_dose_children - 1) * shared.dim.prioritisation_strategy_children.mult[1]]);
    }
    for (size_t i = 1; i <= shared.dim.coverage_target_1st_dose_adults.size; ++i) {
      internal.coverage_target_1st_dose_adults[i - 1] = monty::math::ceil<real_type>(shared.prioritisation_strategy_adults[i - 1 + (prioritisation_step_1st_dose_adults - 1) * shared.dim.prioritisation_strategy_adults.mult[1]]);
    }
    for (size_t i = 1; i <= shared.dim.coverage_target_2nd_dose_adults.size; ++i) {
      internal.coverage_target_2nd_dose_adults[i - 1] = monty::math::ceil<real_type>(shared.prioritisation_strategy_adults[i - 1 + (prioritisation_step_2nd_dose_adults - 1) * shared.dim.prioritisation_strategy_adults.mult[1]]);
    }
    for (size_t i = 1; i <= shared.dim.max_vax_remaining.size; ++i) {
      internal.max_vax_remaining[i - 1] = monty::math::ceil<real_type>((shared.prioritisation_strategy_children[i - 1 + (shared.N_prioritisation_steps_children - 1) * shared.dim.prioritisation_strategy_children.mult[1]] + shared.prioritisation_strategy_adults[i - 1 + (shared.N_prioritisation_steps_adults - 1) * shared.dim.prioritisation_strategy_adults.mult[1]]) * dust2::array::sum<real_type>(N, shared.dim.N, {i - 1, i - 1}, {1, 3})) - dust2::array::sum<real_type>(N, shared.dim.N, {i - 1, i - 1}, {2, 3});
    }
    const real_type births = monty::random::poisson<real_type>(rng_state, dust2::array::sum<real_type>(N, shared.dim.N) * birthrate);
    ...
    for (size_t i = 1; i <= shared.dim.D.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.D.dim[1]; ++j) {
        internal.pre_birthdeath_D[i - 1 + (j - 1) * shared.dim.D.mult[1]] = D[i - 1 + (j - 1) * shared.dim.D.mult[1]] + internal.delta_D[i - 1 + (j - 1) * shared.dim.delta_D.mult[1]];
      }
    }
    const real_type births_vaxxed = monty::random::binomial<real_type>(rng_state, births, shared.proportion_births_vaxxed);
    const real_type births_unvaxxed = monty::random::binomial<real_type>(rng_state, births, (1 - shared.proportion_births_vaxxed));
    ...
    for (size_t i = 1; i <= shared.dim.lambda_hc.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.lambda_hc.dim[1]; ++j) {
        internal.lambda_hc[i - 1 + (j - 1) * shared.dim.lambda_hc.mult[1]] = (i == 20 && time > shared.t_start ? shared.beta_hcw * dust2::array::sum<real_type>(internal.I_infectious.data(), shared.dim.I_infectious) / dust2::array::sum<real_type>(N, shared.dim.N) * (1 - shared.ve_I[i - 1 + (j - 1) * shared.dim.ve_I.mult[1]]) : 0);
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.D.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.D.dim[1]; ++j) {
        internal.new_D[i - 1 + (j - 1) * shared.dim.D.mult[1]] = internal.pre_birthdeath_D[i - 1 + (j - 1) * shared.dim.D.mult[1]];
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.lambda_hh.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.lambda_hh.dim[1]; ++j) {
        internal.lambda_hh[i - 1 + (j - 1) * shared.dim.lambda_hh.mult[1]] = (time > shared.t_start ? shared.beta_h * dust2::array::sum<real_type>(internal.s_ij_gen_pop.data(), shared.dim.s_ij_gen_pop, {i - 1, i - 1}, {0, shared.dim.s_ij_gen_pop.dim[1] - 1}) * (1 - shared.ve_I[i - 1 + (j - 1) * shared.dim.ve_I.mult[1]]) : 0);
      }
    }
    for (size_t i = 1; i <= shared.dim.lambda_s.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.lambda_s.dim[1]; ++j) {
        internal.lambda_s[i - 1 + (j - 1) * shared.dim.lambda_s.mult[1]] = (time > shared.t_start ? shared.beta_s * dust2::array::sum<real_type>(internal.s_ij_sex.data(), shared.dim.s_ij_sex, {i - 1, i - 1}, {0, shared.dim.s_ij_sex.dim[1] - 1}) * (1 - shared.ve_I[i - 1 + (j - 1) * shared.dim.ve_I.mult[1]]) : 0);
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.lambda.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.lambda.dim[1]; ++j) {
        internal.lambda[i - 1 + (j - 1) * shared.dim.lambda.mult[1]] = shared.lambda_z[i - 1 + (j - 1) * shared.dim.lambda_z.mult[1]] + internal.lambda_hh[i - 1 + (j - 1) * shared.dim.lambda_hh.mult[1]] + internal.lambda_s[i - 1 + (j - 1) * shared.dim.lambda_s.mult[1]] + internal.lambda_hc[i - 1 + (j - 1) * shared.dim.lambda_hc.mult[1]];
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.p_SE.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.p_SE.dim[1]; ++j) {
        internal.p_SE[i - 1 + (j - 1) * shared.dim.p_SE.mult[1]] = (internal.lambda[i - 1 + (j - 1) * shared.dim.lambda.mult[1]] > 0 ? 1 - monty::math::exp<real_type>(-internal.lambda[i - 1 + (j - 1) * shared.dim.lambda.mult[1]] * dt) : 0);
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.S.dim[1]; ++j) {
        internal.pre_birthdeath_waning_S[i - 1 + (j - 1) * shared.dim.S.mult[1]] = S[i - 1 + (j - 1) * shared.dim.S.mult[1]] + internal.delta_S_n_vaccination[i - 1 + (j - 1) * shared.dim.delta_S_n_vaccination.mult[1]] - internal.n_SEa[i - 1 + (j - 1) * shared.dim.n_SEa.mult[1]];
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.waning_S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.waning_S.dim[1]; ++j) {
        internal.waning_S[i - 1 + (j - 1) * shared.dim.waning_S.mult[1]] = (j == 1 ? 0 : (j == 2 ? 0 : monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_waning_S[i - 1 + (j - 1) * shared.dim.S.mult[1]], shared.wane_rate)));
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Ea.dim[1]; ++j) {
        internal.pre_birthdeath_Ea[i - 1 + (j - 1) * shared.dim.Ea.mult[1]] = Ea[i - 1 + (j - 1) * shared.dim.Ea.mult[1]] + internal.delta_Ea_n_vaccination[i - 1 + (j - 1) * shared.dim.delta_Ea_n_vaccination.mult[1]] + internal.delta_Ea[i - 1 + (j - 1) * shared.dim.delta_Ea.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.R.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.R.dim[1]; ++j) {
        internal.pre_birthdeath_R[i - 1 + (j - 1) * shared.dim.R.mult[1]] = R[i - 1 + (j - 1) * shared.dim.R.mult[1]] + internal.delta_R_n_vaccination[i - 1 + (j - 1) * shared.dim.delta_R_n_vaccination.mult[1]] + internal.delta_R[i - 1 + (j - 1) * shared.dim.delta_R.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.S.dim[1]; ++j) {
        internal.pre_birthdeath_S[i - 1 + (j - 1) * shared.dim.S.mult[1]] = internal.pre_birthdeath_waning_S[i - 1 + (j - 1) * shared.dim.S.mult[1]] - internal.waning_S[i - 1 + (j - 1) * shared.dim.waning_S.mult[1]] + ((j == 2 ? (internal.waning_S[i - 1 + 2 * shared.dim.waning_S.mult[1]] + internal.waning_S[i - 1 + 3 * shared.dim.waning_S.mult[1]]) : 0));
      }
    }
    ...
    const real_type new_dose1 = dust2::array::sum<real_type>(internal.n_vaccination_t.data(), shared.dim.n_vaccination_t, {0, shared.dim.n_vaccination_t.dim[0] - 1}, {1, 1}) + births_vaxxed;
    const real_type new_dose1_00_04 = internal.n_vaccination_t[shared.dim.n_vaccination_t.mult[1]] + births_vaxxed;
    const real_type new_dose1_SW_12_14 = monty::math::round<real_type>(internal.n_vaccination_t[16 + shared.dim.n_vaccination_t.mult[1]] * static_cast<real_type>(0.5));
    ...
    const real_type new_dose2 = dust2::array::sum<real_type>(internal.n_vaccination_t.data(), shared.dim.n_vaccination_t, {0, shared.dim.n_vaccination_t.dim[0] - 1}, {2, 2}) + births_vaxxed;
    const real_type new_dose2_00_04 = internal.n_vaccination_t[2 * shared.dim.n_vaccination_t.mult[1]] + births_vaxxed;
    const real_type new_dose2_SW_12_14 = monty::math::round<real_type>(internal.n_vaccination_t[16 + 2 * shared.dim.n_vaccination_t.mult[1]] * static_cast<real_type>(0.5));
    ...
    for (size_t i = 1; i <= shared.dim.Eb.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Eb.dim[1]; ++j) {
        internal.pre_birthdeath_Eb[i - 1 + (j - 1) * shared.dim.Eb.mult[1]] = Eb[i - 1 + (j - 1) * shared.dim.Eb.mult[1]] + internal.delta_Eb_n_vaccination[i - 1 + (j - 1) * shared.dim.delta_Eb_n_vaccination.mult[1]] + internal.delta_Eb[i - 1 + (j - 1) * shared.dim.delta_Eb.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_S.dim[1]; ++j) {
        internal.ageout_S[i - 1 + (j - 1) * shared.dim.ageout_S.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_S[i - 1 + (j - 1) * shared.dim.S.mult[1]], shared.ageout_prop[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Ea.dim[1]; ++j) {
        internal.ageout_Ea[i - 1 + (j - 1) * shared.dim.ageout_Ea.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Ea[i - 1 + (j - 1) * shared.dim.Ea.mult[1]], shared.ageout_prop[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_R.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_R.dim[1]; ++j) {
        internal.ageout_R[i - 1 + (j - 1) * shared.dim.ageout_R.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_R[i - 1 + (j - 1) * shared.dim.R.mult[1]], shared.ageout_prop[i - 1]);
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.Id.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Id.dim[1]; ++j) {
        internal.pre_birthdeath_Id[i - 1 + (j - 1) * shared.dim.Id.mult[1]] = Id[i - 1 + (j - 1) * shared.dim.Id.mult[1]] + internal.delta_Id[i - 1 + (j - 1) * shared.dim.delta_Id.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.background_deaths_S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.background_deaths_S.dim[1]; ++j) {
        internal.background_deaths_S[i - 1 + (j - 1) * shared.dim.background_deaths_S.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_S[i - 1 + (j - 1) * shared.dim.S.mult[1]] - internal.ageout_S[i - 1 + (j - 1) * shared.dim.ageout_S.mult[1]], internal.death_rate[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.CSW_progressions_S.size; ++i) {
      internal.CSW_progressions_S[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_S[1 + (i - 1) * shared.dim.ageout_S.mult[1]], shared.prop_SW);
    }
    for (size_t i = 1; i <= shared.dim.PBS_progressions_S.size; ++i) {
      internal.PBS_progressions_S[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_S[3 + (i - 1) * shared.dim.ageout_S.mult[1]], shared.prop_PBS);
    }
    for (size_t i = 1; i <= shared.dim.background_deaths_Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.background_deaths_Ea.dim[1]; ++j) {
        internal.background_deaths_Ea[i - 1 + (j - 1) * shared.dim.background_deaths_Ea.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Ea[i - 1 + (j - 1) * shared.dim.Ea.mult[1]] - internal.ageout_Ea[i - 1 + (j - 1) * shared.dim.ageout_Ea.mult[1]], internal.death_rate[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.CSW_progressions_Ea.size; ++i) {
      internal.CSW_progressions_Ea[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Ea[1 + (i - 1) * shared.dim.ageout_Ea.mult[1]], shared.prop_SW);
    }
    for (size_t i = 1; i <= shared.dim.PBS_progressions_Ea.size; ++i) {
      internal.PBS_progressions_Ea[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Ea[3 + (i - 1) * shared.dim.ageout_Ea.mult[1]], shared.prop_PBS);
    }
    for (size_t i = 1; i <= shared.dim.ageout_Eb.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Eb.dim[1]; ++j) {
        internal.ageout_Eb[i - 1 + (j - 1) * shared.dim.ageout_Eb.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Eb[i - 1 + (j - 1) * shared.dim.Eb.mult[1]], shared.ageout_prop[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.background_deaths_R.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.background_deaths_R.dim[1]; ++j) {
        internal.background_deaths_R[i - 1 + (j - 1) * shared.dim.background_deaths_R.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_R[i - 1 + (j - 1) * shared.dim.R.mult[1]] - internal.ageout_R[i - 1 + (j - 1) * shared.dim.ageout_R.mult[1]], internal.death_rate[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.CSW_progressions_R.size; ++i) {
      internal.CSW_progressions_R[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_R[1 + (i - 1) * shared.dim.ageout_R.mult[1]], shared.prop_SW);
    }
    for (size_t i = 1; i <= shared.dim.PBS_progressions_R.size; ++i) {
      internal.PBS_progressions_R[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_R[3 + (i - 1) * shared.dim.ageout_R.mult[1]], shared.prop_PBS);
    }
    ...
    for (size_t i = 1; i <= shared.dim.Ir.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Ir.dim[1]; ++j) {
        internal.pre_birthdeath_Ir[i - 1 + (j - 1) * shared.dim.Ir.mult[1]] = Ir[i - 1 + (j - 1) * shared.dim.Ir.mult[1]] + internal.delta_Ir[i - 1 + (j - 1) * shared.dim.delta_Ir.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_S.dim[1]; ++j) {
        internal.agein_S[i - 1 + (j - 1) * shared.dim.ageout_S.mult[1]] = (i == 1 ? 0 : (i == 17 ? internal.CSW_progressions_S[j - 1] : (i == 3 ? internal.ageout_S[1 + (j - 1) * shared.dim.ageout_S.mult[1]] - internal.CSW_progressions_S[j - 1] : (i == 19 ? internal.PBS_progressions_S[j - 1] : (i == 20 ? 0 : (i == 5 ? internal.ageout_S[3 + (j - 1) * shared.dim.ageout_S.mult[1]] - internal.PBS_progressions_S[j - 1] : (i == 14 ? internal.ageout_S[12 + (j - 1) * shared.dim.ageout_S.mult[1]] + internal.ageout_S[19 + (j - 1) * shared.dim.ageout_S.mult[1]] : (i == 11 ? internal.ageout_S[9 + (j - 1) * shared.dim.ageout_S.mult[1]] + internal.ageout_S[17 + (j - 1) * shared.dim.ageout_S.mult[1]] + internal.ageout_S[18 + (j - 1) * shared.dim.ageout_S.mult[1]] : internal.ageout_S[i - 1 - 1 + (j - 1) * shared.dim.ageout_S.mult[1]]))))))));
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Ea.dim[1]; ++j) {
        internal.agein_Ea[i - 1 + (j - 1) * shared.dim.ageout_Ea.mult[1]] = (i == 1 ? 0 : (i == 17 ? internal.CSW_progressions_Ea[j - 1] : (i == 3 ? internal.ageout_Ea[1 + (j - 1) * shared.dim.ageout_Ea.mult[1]] - internal.CSW_progressions_Ea[j - 1] : (i == 19 ? internal.PBS_progressions_Ea[j - 1] : (i == 20 ? 0 : (i == 5 ? internal.ageout_Ea[3 + (j - 1) * shared.dim.ageout_Ea.mult[1]] - internal.PBS_progressions_Ea[j - 1] : (i == 14 ? internal.ageout_Ea[12 + (j - 1) * shared.dim.ageout_Ea.mult[1]] + internal.ageout_Ea[19 + (j - 1) * shared.dim.ageout_Ea.mult[1]] : (i == 11 ? internal.ageout_Ea[9 + (j - 1) * shared.dim.ageout_Ea.mult[1]] + internal.ageout_Ea[17 + (j - 1) * shared.dim.ageout_Ea.mult[1]] + internal.ageout_Ea[18 + (j - 1) * shared.dim.ageout_Ea.mult[1]] : internal.ageout_Ea[i - 1 - 1 + (j - 1) * shared.dim.ageout_Ea.mult[1]]))))))));
      }
    }
    for (size_t i = 1; i <= shared.dim.background_deaths_Eb.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.background_deaths_Eb.dim[1]; ++j) {
        internal.background_deaths_Eb[i - 1 + (j - 1) * shared.dim.background_deaths_Eb.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Eb[i - 1 + (j - 1) * shared.dim.Eb.mult[1]] - internal.ageout_Eb[i - 1 + (j - 1) * shared.dim.ageout_Eb.mult[1]], internal.death_rate[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.CSW_progressions_Eb.size; ++i) {
      internal.CSW_progressions_Eb[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Eb[1 + (i - 1) * shared.dim.ageout_Eb.mult[1]], shared.prop_SW);
    }
    for (size_t i = 1; i <= shared.dim.PBS_progressions_Eb.size; ++i) {
      internal.PBS_progressions_Eb[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Eb[3 + (i - 1) * shared.dim.ageout_Eb.mult[1]], shared.prop_PBS);
    }
    for (size_t i = 1; i <= shared.dim.ageout_Id.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Id.dim[1]; ++j) {
        internal.ageout_Id[i - 1 + (j - 1) * shared.dim.ageout_Id.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Id[i - 1 + (j - 1) * shared.dim.Id.mult[1]], shared.ageout_prop[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_R.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_R.dim[1]; ++j) {
        internal.agein_R[i - 1 + (j - 1) * shared.dim.ageout_R.mult[1]] = (i == 1 ? 0 : (i == 17 ? internal.CSW_progressions_R[j - 1] : (i == 3 ? internal.ageout_R[1 + (j - 1) * shared.dim.ageout_R.mult[1]] - internal.CSW_progressions_R[j - 1] : (i == 19 ? internal.PBS_progressions_R[j - 1] : (i == 20 ? 0 : (i == 5 ? internal.ageout_R[3 + (j - 1) * shared.dim.ageout_R.mult[1]] - internal.PBS_progressions_R[j - 1] : (i == 14 ? internal.ageout_R[12 + (j - 1) * shared.dim.ageout_R.mult[1]] + internal.ageout_R[19 + (j - 1) * shared.dim.ageout_R.mult[1]] : (i == 11 ? internal.ageout_R[9 + (j - 1) * shared.dim.ageout_R.mult[1]] + internal.ageout_R[17 + (j - 1) * shared.dim.ageout_R.mult[1]] + internal.ageout_R[18 + (j - 1) * shared.dim.ageout_R.mult[1]] : internal.ageout_R[i - 1 - 1 + (j - 1) * shared.dim.ageout_R.mult[1]]))))))));
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_Eb.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Eb.dim[1]; ++j) {
        internal.agein_Eb[i - 1 + (j - 1) * shared.dim.ageout_Eb.mult[1]] = (i == 1 ? 0 : (i == 17 ? internal.CSW_progressions_Eb[j - 1] : (i == 3 ? internal.ageout_Eb[1 + (j - 1) * shared.dim.ageout_Eb.mult[1]] - internal.CSW_progressions_Eb[j - 1] : (i == 19 ? internal.PBS_progressions_Eb[j - 1] : (i == 20 ? 0 : (i == 5 ? internal.ageout_Eb[3 + (j - 1) * shared.dim.ageout_Eb.mult[1]] - internal.PBS_progressions_Eb[j - 1] : (i == 14 ? internal.ageout_Eb[12 + (j - 1) * shared.dim.ageout_Eb.mult[1]] + internal.ageout_Eb[19 + (j - 1) * shared.dim.ageout_Eb.mult[1]] : (i == 11 ? internal.ageout_Eb[9 + (j - 1) * shared.dim.ageout_Eb.mult[1]] + internal.ageout_Eb[17 + (j - 1) * shared.dim.ageout_Eb.mult[1]] + internal.ageout_Eb[18 + (j - 1) * shared.dim.ageout_Eb.mult[1]] : internal.ageout_Eb[i - 1 - 1 + (j - 1) * shared.dim.ageout_Eb.mult[1]]))))))));
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_Ir.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Ir.dim[1]; ++j) {
        internal.ageout_Ir[i - 1 + (j - 1) * shared.dim.ageout_Ir.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Ir[i - 1 + (j - 1) * shared.dim.Ir.mult[1]], shared.ageout_prop[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.background_deaths_Id.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.background_deaths_Id.dim[1]; ++j) {
        internal.background_deaths_Id[i - 1 + (j - 1) * shared.dim.background_deaths_Id.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Id[i - 1 + (j - 1) * shared.dim.Id.mult[1]] - internal.ageout_Id[i - 1 + (j - 1) * shared.dim.ageout_Id.mult[1]], internal.death_rate[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.CSW_progressions_Id.size; ++i) {
      internal.CSW_progressions_Id[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Id[1 + (i - 1) * shared.dim.ageout_Id.mult[1]], shared.prop_SW);
    }
    for (size_t i = 1; i <= shared.dim.PBS_progressions_Id.size; ++i) {
      internal.PBS_progressions_Id[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Id[3 + (i - 1) * shared.dim.ageout_Id.mult[1]], shared.prop_PBS);
    }
    for (size_t i = 1; i <= shared.dim.S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.S.dim[1]; ++j) {
        internal.new_S[i - 1 + (j - 1) * shared.dim.S.mult[1]] = internal.pre_birthdeath_S[i - 1 + (j - 1) * shared.dim.S.mult[1]] - internal.ageout_S[i - 1 + (j - 1) * shared.dim.ageout_S.mult[1]] - internal.background_deaths_S[i - 1 + (j - 1) * shared.dim.background_deaths_S.mult[1]] + internal.agein_S[i - 1 + (j - 1) * shared.dim.ageout_S.mult[1]] + ((i == 1 && j == 2 ? births_unvaxxed : ((i == 1 && j == 4 ? births_vaxxed : 0))));
      }
    }
    for (size_t i = 1; i <= shared.dim.Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Ea.dim[1]; ++j) {
        internal.new_Ea[i - 1 + (j - 1) * shared.dim.Ea.mult[1]] = internal.pre_birthdeath_Ea[i - 1 + (j - 1) * shared.dim.Ea.mult[1]] - internal.ageout_Ea[i - 1 + (j - 1) * shared.dim.ageout_Ea.mult[1]] - internal.background_deaths_Ea[i - 1 + (j - 1) * shared.dim.background_deaths_Ea.mult[1]] + internal.agein_Ea[i - 1 + (j - 1) * shared.dim.ageout_Ea.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.R.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.R.dim[1]; ++j) {
        internal.new_R[i - 1 + (j - 1) * shared.dim.R.mult[1]] = internal.pre_birthdeath_R[i - 1 + (j - 1) * shared.dim.R.mult[1]] - internal.ageout_R[i - 1 + (j - 1) * shared.dim.ageout_R.mult[1]] - internal.background_deaths_R[i - 1 + (j - 1) * shared.dim.background_deaths_R.mult[1]] + internal.agein_R[i - 1 + (j - 1) * shared.dim.ageout_R.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.background_deaths_Ir.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.background_deaths_Ir.dim[1]; ++j) {
        internal.background_deaths_Ir[i - 1 + (j - 1) * shared.dim.background_deaths_Ir.mult[1]] = monty::random::binomial<real_type>(rng_state, internal.pre_birthdeath_Ir[i - 1 + (j - 1) * shared.dim.Ir.mult[1]] - internal.ageout_Ir[i - 1 + (j - 1) * shared.dim.ageout_Ir.mult[1]], internal.death_rate[i - 1]);
      }
    }
    for (size_t i = 1; i <= shared.dim.CSW_progressions_Ir.size; ++i) {
      internal.CSW_progressions_Ir[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Ir[1 + (i - 1) * shared.dim.ageout_Ir.mult[1]], shared.prop_SW);
    }
    for (size_t i = 1; i <= shared.dim.PBS_progressions_Ir.size; ++i) {
      internal.PBS_progressions_Ir[i - 1] = monty::random::binomial<real_type>(rng_state, internal.ageout_Ir[3 + (i - 1) * shared.dim.ageout_Ir.mult[1]], shared.prop_PBS);
    }
    for (size_t i = 1; i <= shared.dim.ageout_Id.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Id.dim[1]; ++j) {
        internal.agein_Id[i - 1 + (j - 1) * shared.dim.ageout_Id.mult[1]] = (i == 1 ? 0 : (i == 17 ? internal.CSW_progressions_Id[j - 1] : (i == 3 ? internal.ageout_Id[1 + (j - 1) * shared.dim.ageout_Id.mult[1]] - internal.CSW_progressions_Id[j - 1] : (i == 19 ? internal.PBS_progressions_Id[j - 1] : (i == 20 ? 0 : (i == 5 ? internal.ageout_Id[3 + (j - 1) * shared.dim.ageout_Id.mult[1]] - internal.PBS_progressions_Id[j - 1] : (i == 14 ? internal.ageout_Id[12 + (j - 1) * shared.dim.ageout_Id.mult[1]] + internal.ageout_Id[19 + (j - 1) * shared.dim.ageout_Id.mult[1]] : (i == 11 ? internal.ageout_Id[9 + (j - 1) * shared.dim.ageout_Id.mult[1]] + internal.ageout_Id[17 + (j - 1) * shared.dim.ageout_Id.mult[1]] + internal.ageout_Id[18 + (j - 1) * shared.dim.ageout_Id.mult[1]] : internal.ageout_Id[i - 1 - 1 + (j - 1) * shared.dim.ageout_Id.mult[1]]))))))));
      }
    }
    for (size_t i = 1; i <= shared.dim.Eb.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Eb.dim[1]; ++j) {
        internal.new_Eb[i - 1 + (j - 1) * shared.dim.Eb.mult[1]] = internal.pre_birthdeath_Eb[i - 1 + (j - 1) * shared.dim.Eb.mult[1]] - internal.ageout_Eb[i - 1 + (j - 1) * shared.dim.ageout_Eb.mult[1]] - internal.background_deaths_Eb[i - 1 + (j - 1) * shared.dim.background_deaths_Eb.mult[1]] + internal.agein_Eb[i - 1 + (j - 1) * shared.dim.ageout_Eb.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.ageout_Ir.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.ageout_Ir.dim[1]; ++j) {
        internal.agein_Ir[i - 1 + (j - 1) * shared.dim.ageout_Ir.mult[1]] = (i == 1 ? 0 : (i == 17 ? internal.CSW_progressions_Ir[j - 1] : (i == 3 ? internal.ageout_Ir[1 + (j - 1) * shared.dim.ageout_Ir.mult[1]] - internal.CSW_progressions_Ir[j - 1] : (i == 19 ? internal.PBS_progressions_Ir[j - 1] : (i == 20 ? 0 : (i == 5 ? internal.ageout_Ir[3 + (j - 1) * shared.dim.ageout_Ir.mult[1]] - internal.PBS_progressions_Ir[j - 1] : (i == 14 ? internal.ageout_Ir[12 + (j - 1) * shared.dim.ageout_Ir.mult[1]] + internal.ageout_Ir[19 + (j - 1) * shared.dim.ageout_Ir.mult[1]] : (i == 11 ? internal.ageout_Ir[9 + (j - 1) * shared.dim.ageout_Ir.mult[1]] + internal.ageout_Ir[17 + (j - 1) * shared.dim.ageout_Ir.mult[1]] + internal.ageout_Ir[18 + (j - 1) * shared.dim.ageout_Ir.mult[1]] : internal.ageout_Ir[i - 1 - 1 + (j - 1) * shared.dim.ageout_Ir.mult[1]]))))))));
      }
    }
    for (size_t i = 1; i <= shared.dim.Id.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Id.dim[1]; ++j) {
        internal.new_Id[i - 1 + (j - 1) * shared.dim.Id.mult[1]] = internal.pre_birthdeath_Id[i - 1 + (j - 1) * shared.dim.Id.mult[1]] - internal.ageout_Id[i - 1 + (j - 1) * shared.dim.ageout_Id.mult[1]] - internal.background_deaths_Id[i - 1 + (j - 1) * shared.dim.background_deaths_Id.mult[1]] + internal.agein_Id[i - 1 + (j - 1) * shared.dim.ageout_Id.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.E.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.E.dim[1]; ++j) {
    ...
    for (size_t i = 1; i <= shared.dim.Ir.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Ir.dim[1]; ++j) {
        internal.new_Ir[i - 1 + (j - 1) * shared.dim.Ir.mult[1]] = internal.pre_birthdeath_Ir[i - 1 + (j - 1) * shared.dim.Ir.mult[1]] - internal.ageout_Ir[i - 1 + (j - 1) * shared.dim.ageout_Ir.mult[1]] - internal.background_deaths_Ir[i - 1 + (j - 1) * shared.dim.background_deaths_Ir.mult[1]] + internal.agein_Ir[i - 1 + (j - 1) * shared.dim.ageout_Ir.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.I.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.I.dim[1]; ++j) {
    ...
    if (dust2::array::min<real_type>(internal.children_dose1_prob.data(), shared.dim.children_dose1_prob) < 0) {
      Rprintf("[%f] min_child_dose1_prob: %f\n", time, dust2::array::min<real_type>(internal.children_dose1_prob.data(), shared.dim.children_dose1_prob));
    }
    if (internal.daily_doses_children_t[1] - dust2::array::sum<real_type>(internal.children_dose1_group.data(), shared.dim.children_dose1_group, {0, (shared.n_group - 1) - 1}) < 0) {
      Rprintf("[%f] daily_doses_children_t[2]: %f\n", time, internal.daily_doses_children_t[1] - dust2::array::sum<real_type>(internal.children_dose1_group.data(), shared.dim.children_dose1_group, {0, (shared.n_group - 1) - 1}));
    }
    if (dust2::array::min<real_type>(internal.adults_dose1_prob.data(), shared.dim.adults_dose1_prob) < 0) {
      Rprintf("[%f] adults_dose1_prob[]: %f\n", time, dust2::array::min<real_type>(internal.adults_dose1_prob.data(), shared.dim.adults_dose1_prob));
    }
    if (internal.daily_doses_adults_t[1] < 0) {
      Rprintf("[%f] daily_doses_adults_t[2]: %f\n", time, internal.daily_doses_adults_t[1]);
    }
    if (dust2::array::min<real_type>(internal.adults_dose2_prob.data(), shared.dim.adults_dose2_prob) < 0) {
      Rprintf("[%f] adults_dose2_prob[]: %f\n", time, dust2::array::min<real_type>(internal.adults_dose2_prob.data(), shared.dim.adults_dose2_prob));
    }
    if (internal.daily_doses_adults_t[2] < 0) {
      Rprintf("[%f] daily_doses_adults_t[3]: %f\n", time, internal.daily_doses_adults_t[2]);
    }
    if (dust2::array::min<real_type>(internal.adults_dose2_group.data(), shared.dim.adults_dose2_group) < 0) {
      Rprintf("[%f] min(adults_dose2_group): %f\n", time, dust2::array::min<real_type>(internal.adults_dose2_group.data(), shared.dim.adults_dose2_group));
    }
    if (dust2::array::min<real_type>(internal.pre_birthdeath_S.data(), shared.dim.S) < 0) {
      Rprintf("[%f] pre_birthdeath_S: %f\n", time, dust2::array::min<real_type>(internal.pre_birthdeath_S.data(), shared.dim.S));
    }
    if (dust2::array::sum<real_type>(internal.agein_S.data(), shared.dim.ageout_S) - dust2::array::sum<real_type>(internal.ageout_S.data(), shared.dim.ageout_S) != 0) {
      Rprintf("[%f] ageing misalignment S:%f %f\n", time, dust2::array::sum<real_type>(internal.agein_S.data(), shared.dim.ageout_S), dust2::array::sum<real_type>(internal.ageout_S.data(), shared.dim.ageout_S));
    }
    if (dust2::array::min<real_type>(internal.pre_birthdeath_Ea.data(), shared.dim.Ea) < 0) {
      Rprintf("[%f] pre_birthdeath_Ea: %f\n", time, dust2::array::min<real_type>(internal.pre_birthdeath_Ea.data(), shared.dim.Ea));
    }
    if (dust2::array::sum<real_type>(internal.agein_Ea.data(), shared.dim.ageout_Ea) - dust2::array::sum<real_type>(internal.ageout_Ea.data(), shared.dim.ageout_Ea) != 0) {
      Rprintf("[%f] ageing misalignment Ea:%f %f\n", time, dust2::array::sum<real_type>(internal.agein_Ea.data(), shared.dim.ageout_Ea), dust2::array::sum<real_type>(internal.ageout_Ea.data(), shared.dim.ageout_Ea));
    }
    if (dust2::array::min<real_type>(internal.pre_birthdeath_Eb.data(), shared.dim.Eb) < 0) {
      Rprintf("[%f] pre_birthdeath_Eb: %f\n", time, dust2::array::min<real_type>(internal.pre_birthdeath_Eb.data(), shared.dim.Eb));
    }
    if (dust2::array::sum<real_type>(internal.agein_Eb.data(), shared.dim.ageout_Eb) - dust2::array::sum<real_type>(internal.ageout_Eb.data(), shared.dim.ageout_Eb) != 0) {
      Rprintf("[%f] ageing misalignment Eb:%f %f\n", time, dust2::array::sum<real_type>(internal.agein_Eb.data(), shared.dim.ageout_Eb), dust2::array::sum<real_type>(internal.ageout_Eb.data(), shared.dim.ageout_Eb));
    }
    if (dust2::array::min<real_type>(internal.pre_birthdeath_Ir.data(), shared.dim.Ir) < 0) {
      Rprintf("[%f] pre_birthdeath_Ir: %f\n", time, dust2::array::min<real_type>(internal.pre_birthdeath_Ir.data(), shared.dim.Ir));
    }
    if (dust2::array::sum<real_type>(internal.agein_Ir.data(), shared.dim.ageout_Ir) - dust2::array::sum<real_type>(internal.ageout_Ir.data(), shared.dim.ageout_Ir) != 0) {
      Rprintf("[%f] ageing misalignment Ir:%f %f\n", time, dust2::array::sum<real_type>(internal.agein_Ir.data(), shared.dim.ageout_Ir), dust2::array::sum<real_type>(internal.ageout_Ir.data(), shared.dim.ageout_Ir));
    }
    if (dust2::array::min<real_type>(internal.pre_birthdeath_Id.data(), shared.dim.Id) < 0) {
      Rprintf("[%f] pre_birthdeath_Id: %f\n", time, dust2::array::min<real_type>(internal.pre_birthdeath_Id.data(), shared.dim.Id));
    }
    if (dust2::array::sum<real_type>(internal.agein_Id.data(), shared.dim.ageout_Id) - dust2::array::sum<real_type>(internal.ageout_Id.data(), shared.dim.ageout_Id) != 0) {
      Rprintf("[%f] ageing misalignment Id:%f %f\n", time, dust2::array::sum<real_type>(internal.agein_Id.data(), shared.dim.ageout_Id), dust2::array::sum<real_type>(internal.ageout_Id.data(), shared.dim.ageout_Id));
    }
    if (dust2::array::min<real_type>(internal.pre_birthdeath_R.data(), shared.dim.R) < 0) {
      Rprintf("[%f] pre_birthdeath_R: %f\n", time, dust2::array::min<real_type>(internal.pre_birthdeath_R.data(), shared.dim.R));
    }
    ...
    if (dust2::array::min<real_type>(Ea, shared.dim.Ea) < 0) {
      Rprintf("[%f] Ea: %f\n", time, dust2::array::min<real_type>(Ea, shared.dim.Ea));
    }
    if (dust2::array::min<real_type>(Eb, shared.dim.Eb) < 0) {
      Rprintf("[%f] Eb: %f\n", time, dust2::array::min<real_type>(Eb, shared.dim.Eb));
    }
    if (dust2::array::min<real_type>(Ir, shared.dim.Ir) < 0) {
      Rprintf("[%f] Ir: %f\n", time, dust2::array::min<real_type>(Ir, shared.dim.Ir));
    }
    if (dust2::array::min<real_type>(Id, shared.dim.Id) < 0) {
      Rprintf("[%f] Id: %f\n", time, dust2::array::min<real_type>(Id, shared.dim.Id));
    }
    if (dust2::array::min<real_type>(R, shared.dim.R) < 0) {
      Rprintf("[%f] R: %f\n", time, dust2::array::min<real_type>(R, shared.dim.R));
    }
    if (dust2::array::min<real_type>(D, shared.dim.D) < 0) {
      Rprintf("[%f] D: %f\n", time, dust2::array::min<real_type>(D, shared.dim.D));
    }
    if (dust2::array::min<real_type>(internal.n_SEa.data(), shared.dim.n_SEa) < 0) {
      Rprintf("[%f] n_SEa: %f\n", time, dust2::array::min<real_type>(internal.n_SEa.data(), shared.dim.n_SEa));
    }
    if (dust2::array::min<real_type>(internal.lambda.data(), shared.dim.lambda) < 0) {
      Rprintf("[%f] lambda_hh: %f\n", time, dust2::array::min<real_type>(internal.lambda_hh.data(), shared.dim.lambda_hh));
    }
    if (dust2::array::min<real_type>(internal.lambda_s.data(), shared.dim.lambda_s) < 0) {
      Rprintf("[%f] lambda_s: %f\n", time, dust2::array::min<real_type>(internal.lambda_s.data(), shared.dim.lambda_s));
    }
    if (dust2::array::min<real_type>(internal.lambda_hc.data(), shared.dim.lambda_hc) < 0) {
      Rprintf("[%f] lambda_hc: %f\n", time, dust2::array::min<real_type>(internal.lambda_hc.data(), shared.dim.lambda_hc));
    }
    if (dust2::array::min<real_type>(shared.lambda_z.data(), shared.dim.lambda_z) < 0) {
      Rprintf("[%f] lambda_z: %f\n", time, dust2::array::min<real_type>(shared.lambda_z.data(), shared.dim.lambda_z));
    }
    ...
    if (dust2::array::min<real_type>(internal.p_hh.data(), shared.dim.p_hh) < 0) {
      Rprintf("[%f] min(p_hh): %f\n", time, dust2::array::min<real_type>(internal.p_hh.data(), shared.dim.p_hh));
    }
    if (dust2::array::min<real_type>(internal.p_s.data(), shared.dim.p_s) < 0) {
      Rprintf("[%f] min(p_s): %f\n", time, dust2::array::min<real_type>(internal.p_s.data(), shared.dim.p_s));
    }
    if (dust2::array::min<real_type>(internal.p_hc.data(), shared.dim.p_hc) < 0) {
      Rprintf("[%f] min(p_hc): %f\n", time, dust2::array::min<real_type>(internal.p_hc.data(), shared.dim.p_hc));
    }
  }
