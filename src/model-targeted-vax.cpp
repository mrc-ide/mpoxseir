...
public:
  ...
  std::vector<real_type> initial(size_t step, rng_state_type& rng_state) {
    ...
    state[5] = shared->initial_cases_05_15;
    ...
    state[10] = shared->initial_deaths_05_15;
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type cases_0_5 = state[4];
    const real_type cases_05_15 = state[5];
    const real_type cases_15_plus = state[6];
    const real_type cases_PBS = state[7];
    const real_type cases_SW = state[8];
    const real_type deaths = state[3];
    const real_type deaths_0_5 = state[9];
    const real_type deaths_05_15 = state[10];
    const real_type deaths_15_plus = state[11];
    const real_type deaths_PBS = state[12];
    const real_type deaths_SW = state[13];
    ...
    state_next[10] = deaths_05_15 * is_same_week + odin_sum2<real_type>(internal.n_IdD.data(), 1, 3, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[9] = deaths_0_5 * is_same_week + odin_sum2<real_type>(internal.n_IdD.data(), 0, 1, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[11] = deaths_15_plus * is_same_week + odin_sum2<real_type>(internal.n_IdD.data(), 3, 16, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[12] = deaths_PBS * is_same_week + odin_sum2<real_type>(internal.n_IdD.data(), 16, 17, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    state_next[13] = deaths_SW * is_same_week + odin_sum2<real_type>(internal.n_IdD.data(), 17, 18, 0, shared->dim_n_IdD_2, shared->dim_n_IdD_1);
    ...
    state_next[5] = cases_05_15 * is_same_week + odin_sum2<real_type>(internal.n_SEa.data(), 1, 3, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[4] = cases_0_5 * is_same_week + odin_sum2<real_type>(internal.n_SEa.data(), 0, 1, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[6] = cases_15_plus * is_same_week + odin_sum2<real_type>(internal.n_SEa.data(), 3, 16, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[7] = cases_PBS * is_same_week + odin_sum2<real_type>(internal.n_SEa.data(), 16, 17, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
    state_next[8] = cases_SW * is_same_week + odin_sum2<real_type>(internal.n_SEa.data(), 17, 18, 0, shared->dim_n_SEa_2, shared->dim_n_SEa_1);
...
cpp11::sexp dust_info<model_targeted_vax>(const dust::pars_type<model_targeted_vax>& pars) {
  ...
  cpp11::writable::strings nms({"time", "prioritisation_step", "cases", "deaths", "cases_0_5", "cases_05_15", "cases_15_plus", "cases_PBS", "cases_SW", "deaths_0_5", "deaths_05_15", "deaths_15_plus", "deaths_PBS", "deaths_SW", "vax_given_S", "vax_given_Ea", "vax_given_Eb", "vax_given_R", "S_tot", "E_tot", "I_tot", "R_tot", "D_tot", "N_tot", "total_vax", "S", "Ea", "Eb", "Ir", "Id", "R", "D", "E", "I", "N"});
