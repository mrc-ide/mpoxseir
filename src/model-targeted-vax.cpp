...
public:
  ...
  struct data_type {
    ...
    real_type cases_HCW;
    real_type cases_SW;
    real_type cases_cumul_00_04;
    real_type cases_cumul_00_14;
    real_type cases_cumul_total;
  };
  ...
  static data_type build_data(cpp11::list data, const shared_state& shared) {
    ...
    auto cases_cumul_00_04 = dust2::r::read_real(data, "cases_cumul_00_04", NA_REAL);
    auto cases_cumul_00_14 = dust2::r::read_real(data, "cases_cumul_00_14", NA_REAL);
    auto cases_cumul_total = dust2::r::read_real(data, "cases_cumul_total", NA_REAL);
    return data_type{cases, cases_00_04, cases_05_14, cases_15_plus, deaths, deaths_00_04, deaths_05_14, deaths_15_plus, cfr_00_04, cfr_05_14, cfr_15_plus, cases_total, cases_HCW, cases_SW, cases_cumul_00_04, cases_cumul_00_14, cases_cumul_total};
  }
  ...
  static real_type compare_data(real_type time, const real_type* state, const data_type& data, const shared_state& shared, internal_state& internal, rng_state_type& rng_state) {
    ...
    const real_type model_cumul_cases_00_04 = cases_cumulative_00_04 + monty::random::exponential_rate<real_type>(rng_state, shared.exp_noise);
    const real_type model_cumul_cases_05_14 = cases_cumulative_05_14 + monty::random::exponential_rate<real_type>(rng_state, shared.exp_noise);
    const real_type model_cumul_cases_15_plus = cases_cumulative_15_plus + monty::random::exponential_rate<real_type>(rng_state, shared.exp_noise);
    ...
    const real_type model_cumul_cases_00_14 = model_cumul_cases_00_04 + model_cumul_cases_05_14;
    const real_type model_cumul_cases_total = model_cumul_cases_00_14 + model_cumul_cases_15_plus;
