...
public:
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    state_next[0] = monty::math::min<real_type>(prioritisation_step_1st_dose_children_proposal, shared.N_prioritisation_steps_children);
    state_next[1] = monty::math::min<real_type>(prioritisation_step_1st_dose_adults_proposal, shared.N_prioritisation_steps_adults);
    state_next[2] = monty::math::min<real_type>(prioritisation_step_2nd_dose_adults_proposal, shared.N_prioritisation_steps_adults);
