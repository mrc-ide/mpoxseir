...
public:
  ...
  static void initial(real_type time, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state) {
    ...
    for (size_t i = 1; i <= shared.dim.S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.S.dim[1]; ++j) {
        state[i - 1 + (j - 1) * shared.dim.S.mult[1] + 109] = shared.S0[i - 1 + (j - 1) * shared.dim.S0.mult[1]];
      }
    }
    for (size_t i = 1; i <= shared.dim.Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Ea.dim[1]; ++j) {
        state[i - 1 + (j - 1) * shared.dim.Ea.mult[1] + shared.odin.offset.state[110]] = shared.Ea0[i - 1 + (j - 1) * shared.dim.Ea0.mult[1]];
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.E.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.E.dim[1]; ++j) {
        state[i - 1 + (j - 1) * shared.dim.E.mult[1] + shared.odin.offset.state[116]] = shared.Ea0[i - 1 + (j - 1) * shared.dim.Ea0.mult[1]] + shared.Eb0[i - 1 + (j - 1) * shared.dim.Eb0.mult[1]];
      }
    }
  ...
  static auto zero_every(const shared_state& shared) {
    return dust2::zero_every_type<real_type>{{7, {3}}, {7, {4}}, {7, {11}}, {7, {12}}, {7, {13}}, {7, {14}}, {7, {15}}, {7, {16}}, {7, {17}}, {7, {18}}, {7, {19}}, {7, {20}}, {7, {21}}, {7, {22}}, {7, {23}}, {7, {24}}, {7, {25}}, {7, {26}}, {7, {27}}, {7, {28}}, {7, {29}}, {7, {30}}, {7, {31}}, {7, {32}}, {7, {33}}, {7, {34}}, {7, {35}}, {7, {36}}, {7, {37}}, {7, {38}}, {7, {39}}, {7, {40}}, {7, {41}}, {7, {42}}, {7, {43}}, {7, {44}}, {1, {100}}, {1, {101}}, {1, {102}}, {1, {103}}, {1, {104}}, {1, {105}}, {1, {106}}, {1, {107}}, {1, {108}}};
  }
