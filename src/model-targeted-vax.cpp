...
// Generated by odin2 (version 0.1.7) - do not edit
...
public:
  ...
  static shared_state build_shared(cpp11::list parameters) {
    ...
    offset.state.deaths_inc_00_04 = 11;
    offset.state.deaths_inc_05_14 = 12;
    offset.state.deaths_inc_15_plus = 13;
    offset.state.deaths_inc_PBS = 14;
    offset.state.deaths_inc_SW = 15;
    offset.state.cases_cumulative_00_04 = 16;
    offset.state.cases_cumulative_05_14 = 17;
    offset.state.cases_cumulative_15_plus = 18;
    offset.state.cases_cumulative_PBS = 19;
    offset.state.cases_cumulative_SW = 20;
    offset.state.deaths_cumulative_00_04 = 21;
    offset.state.deaths_cumulative_05_14 = 22;
    offset.state.deaths_cumulative_15_plus = 23;
    offset.state.deaths_cumulative_PBS = 24;
    offset.state.deaths_cumulative_SW = 25;
    offset.state.vax_given_S = 26;
    offset.state.vax_given_Ea = 27;
    offset.state.vax_given_Eb = 28;
    offset.state.vax_given_R = 29;
    offset.state.vax_1stdose_given_S = 30;
    offset.state.vax_1stdose_given_Ea = 31;
    offset.state.vax_1stdose_given_Eb = 32;
    offset.state.vax_1stdose_given_R = 33;
    offset.state.vax_2nddose_given_S = 34;
    offset.state.vax_2nddose_given_Ea = 35;
    offset.state.vax_2nddose_given_Eb = 36;
    offset.state.vax_2nddose_given_R = 37;
    offset.state.S_tot = 38;
    offset.state.E_tot = 39;
    offset.state.I_tot = 40;
    offset.state.R_tot = 41;
    offset.state.D_tot = 42;
    offset.state.N_tot = 43;
    offset.state.total_vax = 44;
    offset.state.total_vax_1stdose = 45;
    offset.state.total_vax_2nddose = 46;
    offset.state.S = 47;
    offset.state.Ea = 47 + dim_S.size;
  ...
  static data_type build_data(cpp11::list data, const shared_state& shared) {
    auto cases = dust2::r::read_real(data, "cases");
    auto cases_00_04 = dust2::r::read_real(data, "cases_00_04");
    auto cases_05_14 = dust2::r::read_real(data, "cases_05_14");
    auto cases_15_plus = dust2::r::read_real(data, "cases_15_plus");
    auto deaths = dust2::r::read_real(data, "deaths");
    auto deaths_00_04 = dust2::r::read_real(data, "deaths_00_04");
    auto deaths_05_14 = dust2::r::read_real(data, "deaths_05_14");
    auto deaths_15_plus = dust2::r::read_real(data, "deaths_15_plus");
  ...
  static void initial(real_type time, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state) {
    ...
    for (size_t i = 1; i <= shared.dim.S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.S.dim[1]; ++j) {
        state[i - 1 + (j - 1) * (shared.dim.S.mult[1]) + 47] = shared.S0[i - 1 + (j - 1) * (shared.dim.S0.mult[1])];
      }
    }
    ...
    state[36] = 0;
    state[37] = 0;
    state[38] = dust2::array::sum<real_type>(shared.S0.data(), shared.dim.S0);
    state[39] = dust2::array::sum<real_type>(shared.Ea0.data(), shared.dim.Ea0) + dust2::array::sum<real_type>(shared.Eb0.data(), shared.dim.Eb0);
    state[40] = dust2::array::sum<real_type>(shared.Ir0.data(), shared.dim.Ir0) + dust2::array::sum<real_type>(shared.Id0.data(), shared.dim.Id0);
    state[41] = dust2::array::sum<real_type>(shared.R0.data(), shared.dim.R0);
    state[42] = dust2::array::sum<real_type>(shared.D0.data(), shared.dim.D0);
    state[43] = dust2::array::sum<real_type>(shared.S0.data(), shared.dim.S0) + dust2::array::sum<real_type>(shared.Ea0.data(), shared.dim.Ea0) + dust2::array::sum<real_type>(shared.Eb0.data(), shared.dim.Eb0) + dust2::array::sum<real_type>(shared.Ir0.data(), shared.dim.Ir0) + dust2::array::sum<real_type>(shared.Id0.data(), shared.dim.Id0) + dust2::array::sum<real_type>(shared.R0.data(), shared.dim.R0) + dust2::array::sum<real_type>(shared.D0.data(), shared.dim.D0);
    state[44] = 0;
    state[45] = 0;
    state[46] = 0;
  }
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    const auto deaths_inc_00_04 = state[11];
    const auto deaths_inc_05_14 = state[12];
    const auto deaths_inc_15_plus = state[13];
    const auto deaths_inc_PBS = state[14];
    const auto deaths_inc_SW = state[15];
    const auto cases_cumulative_00_04 = state[16];
    const auto cases_cumulative_05_14 = state[17];
    const auto cases_cumulative_15_plus = state[18];
    const auto cases_cumulative_PBS = state[19];
    const auto cases_cumulative_SW = state[20];
    const auto deaths_cumulative_00_04 = state[21];
    const auto deaths_cumulative_05_14 = state[22];
    const auto deaths_cumulative_15_plus = state[23];
    const auto deaths_cumulative_PBS = state[24];
    const auto deaths_cumulative_SW = state[25];
    const auto vax_given_S = state[26];
    const auto vax_given_Ea = state[27];
    const auto vax_given_Eb = state[28];
    const auto vax_given_R = state[29];
    const auto vax_1stdose_given_S = state[30];
    const auto vax_1stdose_given_Ea = state[31];
    const auto vax_1stdose_given_Eb = state[32];
    const auto vax_1stdose_given_R = state[33];
    const auto vax_2nddose_given_S = state[34];
    const auto vax_2nddose_given_Ea = state[35];
    const auto vax_2nddose_given_Eb = state[36];
    const auto vax_2nddose_given_R = state[37];
    const auto total_vax = state[44];
    const auto total_vax_1stdose = state[45];
    const auto total_vax_2nddose = state[46];
    ...
    for (size_t i = 1; i <= shared.dim.prop_infectious.size; ++i) {
      internal.prop_infectious[i - 1] = dust2::array::sum<real_type>(internal.I_infectious.data(), shared.dim.I_infectious, {i - 1, i - 1}, {0, shared.dim.I_infectious.dim[1] - 1}) / dust2::array::sum<real_type>(N, shared.dim.N, {i - 1, i - 1}, {0, shared.dim.N.dim[1] - 1});
    }
    ...
    state_next[26] = dust2::array::sum<real_type>(internal.n_vaccination_t_S.data(), shared.dim.n_vaccination_t_S);
    state_next[27] = dust2::array::sum<real_type>(internal.n_vaccination_t_Ea.data(), shared.dim.n_vaccination_t_Ea);
    state_next[28] = dust2::array::sum<real_type>(internal.n_vaccination_t_Eb.data(), shared.dim.n_vaccination_t_Eb);
    state_next[29] = dust2::array::sum<real_type>(internal.n_vaccination_t_R.data(), shared.dim.n_vaccination_t_R);
    state_next[30] = dust2::array::sum<real_type>(internal.n_vaccination_t_S.data(), shared.dim.n_vaccination_t_S, {0, shared.dim.n_vaccination_t_S.dim[0] - 1}, {1, 1});
    state_next[31] = dust2::array::sum<real_type>(internal.n_vaccination_t_Ea.data(), shared.dim.n_vaccination_t_Ea, {0, shared.dim.n_vaccination_t_Ea.dim[0] - 1}, {1, 1});
    state_next[32] = dust2::array::sum<real_type>(internal.n_vaccination_t_Eb.data(), shared.dim.n_vaccination_t_Eb, {0, shared.dim.n_vaccination_t_Eb.dim[0] - 1}, {1, 1});
    state_next[33] = dust2::array::sum<real_type>(internal.n_vaccination_t_R.data(), shared.dim.n_vaccination_t_R, {0, shared.dim.n_vaccination_t_R.dim[0] - 1}, {1, 1});
    state_next[34] = dust2::array::sum<real_type>(internal.n_vaccination_t_S.data(), shared.dim.n_vaccination_t_S, {0, shared.dim.n_vaccination_t_S.dim[0] - 1}, {2, 2});
    state_next[35] = dust2::array::sum<real_type>(internal.n_vaccination_t_Ea.data(), shared.dim.n_vaccination_t_Ea, {0, shared.dim.n_vaccination_t_Ea.dim[0] - 1}, {2, 2});
    state_next[36] = dust2::array::sum<real_type>(internal.n_vaccination_t_Eb.data(), shared.dim.n_vaccination_t_Eb, {0, shared.dim.n_vaccination_t_Eb.dim[0] - 1}, {2, 2});
    state_next[37] = dust2::array::sum<real_type>(internal.n_vaccination_t_R.data(), shared.dim.n_vaccination_t_R, {0, shared.dim.n_vaccination_t_R.dim[0] - 1}, {2, 2});
    for (size_t i = 1; i <= shared.dim.S.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.S.dim[1]; ++j) {
        state_next[i - 1 + (j - 1) * (shared.dim.S.mult[1]) + 47] = S[i - 1 + (j - 1) * (shared.dim.S.mult[1])] + internal.delta_S_n_vaccination[i - 1 + (j - 1) * (shared.dim.delta_S_n_vaccination.mult[1])] - internal.n_SEa[i - 1 + (j - 1) * (shared.dim.n_SEa.mult[1])];
      }
    }
    for (size_t i = 1; i <= shared.dim.Ea.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.Ea.dim[1]; ++j) {
    ...
    state_next[6] = cases_inc_00_04 + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {0, 0}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[7] = cases_inc_05_14 + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {1, 2}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[8] = cases_inc_15_plus + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {3, 15}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[9] = cases_inc_PBS + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {16, 16}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[10] = cases_inc_SW + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {17, 17}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[4] = cases_cumulative + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa);
    state_next[16] = cases_cumulative_00_04 + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {0, 0}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[17] = cases_cumulative_05_14 + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {1, 2}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[18] = cases_cumulative_15_plus + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {3, 15}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[19] = cases_cumulative_PBS + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {16, 16}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[20] = cases_cumulative_SW + dust2::array::sum<real_type>(internal.n_SEa.data(), shared.dim.n_SEa, {17, 17}, {0, shared.dim.n_SEa.dim[1] - 1});
    state_next[3] = deaths_inc + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD);
    state_next[11] = deaths_inc_00_04 + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {0, 0}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[12] = deaths_inc_05_14 + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {1, 2}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[13] = deaths_inc_15_plus + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {3, 15}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[14] = deaths_inc_PBS + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {16, 16}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[15] = deaths_inc_SW + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {17, 17}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[5] = deaths_cumulative + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD);
    state_next[21] = deaths_cumulative_00_04 + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {0, 0}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[22] = deaths_cumulative_05_14 + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {1, 2}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[23] = deaths_cumulative_15_plus + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {3, 15}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[24] = deaths_cumulative_PBS + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {16, 16}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[25] = deaths_cumulative_SW + dust2::array::sum<real_type>(internal.n_IdD.data(), shared.dim.n_IdD, {17, 17}, {0, shared.dim.n_IdD.dim[1] - 1});
    state_next[38] = dust2::array::sum<real_type>(S, shared.dim.S);
    state_next[39] = dust2::array::sum<real_type>(E, shared.dim.E);
    state_next[40] = dust2::array::sum<real_type>(I, shared.dim.I);
    state_next[41] = dust2::array::sum<real_type>(R, shared.dim.R);
    state_next[42] = dust2::array::sum<real_type>(D, shared.dim.D);
    state_next[43] = dust2::array::sum<real_type>(N, shared.dim.N);
    state_next[44] = total_vax + vax_given_S + vax_given_Ea + vax_given_Eb + vax_given_R;
    state_next[45] = total_vax_1stdose + vax_1stdose_given_S + vax_1stdose_given_Ea + vax_1stdose_given_Eb + vax_1stdose_given_R;
    state_next[46] = total_vax_2nddose + vax_2nddose_given_S + vax_2nddose_given_Ea + vax_2nddose_given_Eb + vax_2nddose_given_R;
  }
  static auto zero_every(const shared_state& shared) {
    return dust2::zero_every_type<real_type>{{7, {2}}, {7, {3}}, {7, {6}}, {7, {7}}, {7, {8}}, {7, {9}}, {7, {10}}, {7, {11}}, {7, {12}}, {7, {13}}, {7, {14}}, {7, {15}}};
  }
...
SEXP dust2_system_model_targeted_vax_set_state(cpp11::sexp ptr, cpp11::sexp r_state, bool preserve_group_dimension) {
  return dust2::r::dust2_system_set_state<dust2::dust_discrete<model_targeted_vax>>(ptr, r_state, preserve_group_dimension);
}
...
SEXP dust2_unfilter_model_targeted_vax_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_index_state) {
  return dust2::r::dust2_discrete_unfilter_alloc<model_targeted_vax>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_index_state);
}
...
SEXP dust2_filter_model_targeted_vax_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_index_state, cpp11::sexp r_seed) {
  return dust2::r::dust2_discrete_filter_alloc<model_targeted_vax>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_index_state, r_seed);
}
[[cpp11::register]]
...
SEXP dust2_unfilter_model_targeted_vax_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_history, bool adjoint, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_run<dust2::dust_discrete<model_targeted_vax>>(ptr, r_initial, save_history, adjoint, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_model_targeted_vax_last_history(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_history<dust2::dust_discrete<model_targeted_vax>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_model_targeted_vax_last_state(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_state<dust2::dust_discrete<model_targeted_vax>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_model_targeted_vax_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_history, bool adjoint, cpp11::sexp index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_run<dust2::dust_discrete<model_targeted_vax>>(ptr, r_initial, save_history, adjoint, index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_model_targeted_vax_last_history(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_history<dust2::dust_discrete<model_targeted_vax>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_model_targeted_vax_last_state(cpp11::sexp ptr, cpp11::sexp r_index_group, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_state<dust2::dust_discrete<model_targeted_vax>>(ptr, r_index_group, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
