...
public:
  ...
  static internal_state build_internal(const shared_state& shared) {
    ...
    return internal_state{n_IrR, n_IdD, target_met_children_t, coverage_target_1st_dose_children, coverage_target_1st_dose_adults, coverage_target_2nd_dose_adults, max_vax_remaining, I_infectious, delta_R, delta_D, daily_doses_children_t, daily_doses_adults_t, target_met_adults_t, give_dose1_children, new_D, prop_infectious, lambda_hc, give_dose1_adults, give_dose2_adults, children_dose1_denom, s_ij_gen_pop, s_ij_sex, adults_dose1_denom, adults_dose2_denom, children_dose1_prob, lambda_hh, lambda_s, children_dose1_group, adults_dose1_prob, adults_dose2_prob, lambda, n_vaccination_t_S_children, adults_dose1_group, adults_dose2_group, p_SE, p_hh, p_s, p_hc, n_vaccination_t_Ea_children, n_vaccination_t_S_adults, n_vaccination_t_Eb_children, n_vaccination_t_Ea_adults, n_vaccination_t_S, n_vaccination_t_R_children, n_vaccination_t_Eb_adults, n_vaccination_t_Ea, delta_S_n_vaccination, n_vaccination_t_R_adults, n_vaccination_t_Eb, delta_Ea_n_vaccination, n_SEa, n_vaccination_t_R, delta_Eb_n_vaccination, new_S, n_SEa_hh, n_EaEb, delta_R_n_vaccination, n_vaccination_t, n_SEa_s, n_EbI, delta_Ea, new_Ea, new_R, n_SEa_hc, n_EbId, delta_Eb, new_Eb, n_SEa_z, n_EbIr, delta_Id, new_Id, new_E, delta_Ir, new_Ir, new_I, new_N, seed};
  }
